...
context("Targeting", () => {
  ...
  it("Create a target population", () => {
    ...
    cy.uniqueSeed().then((seed) => {
      ...
      cy.get('[data-cy="button-individual-rule"]').should('be.not.disabled',{timeout:30000}).click({ force: true })
      ...
      cy.get('[data-cy="button-target-population-lock"]').should('to.visible',{timeout:100000});
