...
class TestUpdateAdminAreaFromFile(TestCase):
    ...
    def setUpTestData(cls) -> None:
        ...
        area_type_level_4 = AreaTypeFactory(name="State4", area_level=4)
        cls.area1 = AreaFactory(name="City Test1", area_type=area_type_level_1, p_code="area1")
        cls.area2 = AreaFactory(name="City Test2", area_type=area_type_level_2, p_code=admin1_area_id, parent=cls.area1)
        cls.area3 = AreaFactory(name="City Test3", area_type=area_type_level_3, p_code=admin2_area_id, parent=cls.area2)
        cls.area4 = AreaFactory(name="City Test4", area_type=area_type_level_4, p_code=admin3_area_id, parent=cls.area3)
    ...
    def test_update_household_admin_areas(self) -> None:
        ...
        self.assertEqual(self.household.admin3, self.area4)
