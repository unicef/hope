from hct_mis_api.apps.grievance.models import TicketIndividualDataUpdateDetails, GrievanceTicket
...
def fix_individual_data_update_details_document_type() -> None:
    ...
    print(f"Found {tickets_qs.count()} tickets. \n Start fixing...", )
