...
DEFAULTS = {
    ...
    "CELERY_RESULT_BACKEND": (str, "redis://redis/2"),
    "CELERY_TASK_ALWAYS_EAGER": (bool, False),
    "CONSTANCE_REDIS_CONNECTION": (str, "redis://redis/0"),
    "DATABASE_URL": (str, "psql://postgres:@127.0.0.1:5432/hope"),
    "DATABASE_URL_HUB_CA": (str, ""),
    "DATABASE_URL_HUB_ERP": (str, ""),
    "DATABASE_URL_HUB_MIS": (str, ""),
    "DATABASE_URL_HUB_REGISTRATION": (str, ""),
