...
class DataCollectingTypeViewSet(ListModelMixin, GenericViewSet):
...
class ProgramViewSet(CreateModelMixin, ListModelMixin, HOPEAPIBusinessAreaViewSet):
    ...
    def create(self, request: "Request", *args: Any, **kwargs: Any) -> Response:
        business_area_slug = self.kwargs.get("business_area")
        business_area = get_object_or_404(BusinessArea, slug=business_area_slug)

        serializer = ProgramSerializer(data={**request.data, "business_area": business_area.id})
