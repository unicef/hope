...
MEDIA_STORAGE_AZURE_ACCOUNT_NAME = os.getenv(
    "MEDIA_STORAGE_AZURE_ACCOUNT_NAME", AZURE_ACCOUNT_NAME
)
MEDIA_STORAGE_AZURE_ACCOUNT_KEY = os.getenv(
    "MEDIA_STORAGE_AZURE_ACCOUNT_KEY", AZURE_ACCOUNT_KEY
)
STATIC_STORAGE_AZURE_ACCOUNT_NAME = os.getenv(
    "STATIC_STORAGE_AZURE_ACCOUNT_NAME", AZURE_ACCOUNT_NAME
)
STATIC_STORAGE_AZURE_ACCOUNT_KEY = os.getenv(
    "STATIC_STORAGE_AZURE_ACCOUNT_KEY", AZURE_ACCOUNT_KEY
)

AZURE_URL_EXPIRATION_SECS = 10800

AZURE_STATIC_CUSTOM_DOMAIN = (
    f"{STATIC_STORAGE_AZURE_ACCOUNT_NAME}.blob.core.windows.net"
)
