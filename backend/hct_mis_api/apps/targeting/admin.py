...
class TargetPopulationAdmin(ExtraUrlMixin, HOPEModelAdminBase):
    ...
    def test_steficon(self, request, pk):
        ...
        if request.method == 'GET':
            ...
            context["form"] = RuleTestForm(initial={'number_of_records': 100,
...
class HouseholdSelectionAdmin(HOPEModelAdminBase):
    ...
    raw_id_fields = ("household", "target_population",)
    list_filter = (TextFieldFilter.factory("household__unicef_id", "Household ID"),
