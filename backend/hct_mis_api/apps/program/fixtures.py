...
class ProgramFactory(factory.DjangoModelFactory):
    ...
    description = factory.Faker("sentence", nb_words=10, variable_nb_words=True, ext_word_list=None,)
    locations = factory.SubFactory(AdminAreaFactory)
    budget = factory.fuzzy.FuzzyDecimal(1000000.0, 900000000.0)
    frequency_of_payments = fuzzy.FuzzyChoice(Program.FREQUENCY_OF_PAYMENTS_CHOICE, getter=lambda c: c[0],)
