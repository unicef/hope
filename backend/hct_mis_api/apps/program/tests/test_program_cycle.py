...
class TestProgramCycle(APITestCase):
    ...
    @parameterized.expand(
        [
            ...
            ("with_permission_program_in_draft", [Permissions.PROGRAMME_CREATE], Program.DRAFT, {}),
            (
    ...
    def test_delete_program_cycle(self) -> None:
        ...
        self.create_user_role_with_permissions(self.user, [Permissions.PROGRAMME_REMOVE], self.business_area)
