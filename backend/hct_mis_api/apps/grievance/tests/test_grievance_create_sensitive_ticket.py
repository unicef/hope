...
class TestGrievanceCreateSensitiveTicketQuery(APITestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.admin_area = AdminAreaFactory(title="City Test", admin_area_level=area_type, p_code="asfdsfg")
        ...
        AreaFactory(name="City Test", area_type=area_type, p_code="asfdsfg")
