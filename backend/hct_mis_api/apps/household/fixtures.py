...
class HouseholdFactory(factory.DjangoModelFactory):
    ...
    female_age_group_0_4_count = factory.fuzzy.FuzzyInteger(0, 3)
    female_age_group_5_12_count = factory.fuzzy.FuzzyInteger(0, 3)
    female_age_group_13_17_count = factory.fuzzy.FuzzyInteger(0, 3)
    ...
    male_age_group_0_4_count = factory.fuzzy.FuzzyInteger(0, 3)
    male_age_group_5_12_count = factory.fuzzy.FuzzyInteger(0, 3)
    male_age_group_13_17_count = factory.fuzzy.FuzzyInteger(0, 3)
