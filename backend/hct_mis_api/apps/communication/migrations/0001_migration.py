# Generated by Django 3.2.13 on 2022-09-14 13:30
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        CREATE OR REPLACE FUNCTION create_message_unicef_id() RETURNS trigger
            ...
            AS $$
        BEGIN
            NEW.unicef_id := format('MSG-%s', NEW.unicef_id_index);
            return NEW;
        END
        $$;
        ...
        migrations.RunSQL(
            sql="UPDATE communication_message SET unicef_id = format('MSG-%s', unicef_id_index);",
