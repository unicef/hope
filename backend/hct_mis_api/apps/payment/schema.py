...
class PaymentPlanNode(BaseNodePermissionMixin, AdminUrlNodeMixin, DjangoObjectType):
    ...
    excluded_households = graphene.List(HouseholdNode, description="For not social worker DCT return Household IDs")
    excluded_individuals = graphene.List(IndividualNode, description="For social worker DCT return Individual IDs")
