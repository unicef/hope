# Generated by Django 3.2.15 on 2022-11-16 15:58
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='payment_channels', to='payment.deliverymechanism'),
        ),
        migrations.CreateModel(
            name='PaymentChannelData',
            fields=[
                ('id', model_utils.fields.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('created_at', models.DateTimeField(auto_now_add=True, db_index=True)),
                ('updated_at', models.DateTimeField(auto_now=True, db_index=True)),
                ('data', models.JSONField(blank=True, default=dict)),
                ('individual', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='payment_channel_data', to='household.individual')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='paymentchannel',
            name='payment_channel_data',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='payment.paymentchanneldata'),
        ),
    ]
