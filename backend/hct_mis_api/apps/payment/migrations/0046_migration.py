    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('distrubution_limit', models.DecimalField(decimal_places=2, help_text='The maximum amount of money that can be distributed or unlimited if 0', max_digits=12, null=True, validators=[django.core.validators.MinValueValidator(Decimal('0.01'))])),
