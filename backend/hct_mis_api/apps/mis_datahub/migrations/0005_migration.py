# Generated by Django 2.2.8 on 2020-06-18 13:08
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "source",
                    models.CharField(
                        choices=[("MIS", "HCT-MIS"), ("CA", "Cash Assist")],
                        max_length=3,
                    ),
                ),
                (
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="mis_datahub.Session",
                    ),
                ),
            ],
            options={
                "unique_together": {
                    ("session", "household_mis_id", "target_population_mis_id")
                },
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "population_type",
                    models.CharField(default="HOUSEHOLD", max_length=20),
                ),
            ...
            options={"unique_together": {("session", "mis_id")},},
        ),
        migrations.CreateModel(
            name="Program",
            fields=[
        ...
        migrations.RunPython(unmark_sent_tp),
    ]
