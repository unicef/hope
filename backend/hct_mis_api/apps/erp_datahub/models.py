...
class FundsCommitment(SessionModel):
    ...
    commitment_amount_local = models.DecimalField(
        decimal_places=2, max_digits=13, validators=[MinValueValidator(Decimal("0.01"))], null=True,
    )
    commitment_amount_usd = models.DecimalField(
        decimal_places=2, max_digits=13, validators=[MinValueValidator(Decimal("0.01"))], null=True,
    )
    total_open_amount_local = models.DecimalField(
        decimal_places=2, max_digits=13, validators=[MinValueValidator(Decimal("0.01"))],
    )
    total_open_amount_usd = models.DecimalField(
        decimal_places=2, max_digits=13, validators=[MinValueValidator(Decimal("0.01"))], null=True,
    )
    exchange_rate = models.DecimalField(
        decimal_places=5, max_digits=9, validators=[MinValueValidator(Decimal("0.00001"))], null=True,
    )
