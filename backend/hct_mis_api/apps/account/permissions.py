...
class Permissions(Enum):
    ...
    PM_FINANCIAL_SERVICE_PROVIDER_VIEW_LIST_AND_DETAILS = auto()
    PM_FINANCIAL_SERVICE_PROVIDER_VIEW_DETAILS = auto()
    PM_FINANCIAL_SERVICE_PROVIDER_CREATE = auto()
    PM_FINANCIAL_SERVICE_PROVIDER_UPDATE = auto()
    PM_FINANCIAL_SERVICE_PROVIDER_REMOVE = auto()
    PM_FINANCIAL_SERVICE_PROVIDER_ACTIVATE = auto()
    ...
    PM_FINANCIAL_SERVICE_PROVIDER_XLSX_TEMPLATE_VIEW_LIST_AND_DETAILS = auto()
    PM_FINANCIAL_SERVICE_PROVIDER_XLSX_TEMPLATE_VIEW_DETAILS = auto()
