...
class Permissions(Enum):
    ...
    PAYMENT_MODULE_IMPORT_XLSX_WITH_ENTITLEMENTS = auto()
    PAYMENT_MODULE_APPLY_RULE_ENGINE_FORMULA_WITH_ENTITLEMENTS = auto()

    FINANCIAL_SERVICE_PROVIDER_VIEW_LIST_AND_DETAILS = auto()
    FINANCIAL_SERVICE_PROVIDER_VIEW_DETAILS = auto()
    FINANCIAL_SERVICE_PROVIDER_CREATE = auto()
    FINANCIAL_SERVICE_PROVIDER_UPDATE = auto()
    FINANCIAL_SERVICE_PROVIDER_REMOVE = auto()
    FINANCIAL_SERVICE_PROVIDER_ACTIVATE = auto()

    FINANCIAL_SERVICE_PROVIDER_XLSX_TEMPLATE_VIEW_LIST_AND_DETAILS = auto()
    FINANCIAL_SERVICE_PROVIDER_XLSX_TEMPLATE_VIEW_DETAILS = auto()
