...
class Permissions(Enum):
    ...
    GRIEVANCES_FEEDBACK_TO_HOUSEHOLD = auto()
    GRIEVANCES_FEEDBACK_TO_HOUSEHOLD_AS_CREATOR = auto()
    GRIEVANCES_FEEDBACK_TO_HOUSEHOLD_AS_OWNER = auto()
    ...
    GRIEVANCES_APPROVE_COMPLAINT = auto()
    GRIEVANCES_APPROVE_COMPLAINT_AS_CREATOR = auto()
    GRIEVANCES_APPROVE_COMPLAINT_AS_OWNER = auto()
