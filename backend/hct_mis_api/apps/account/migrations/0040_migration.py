            ...
            field=hct_mis_api.apps.account.models.ChoiceArrayField(
                base_field=models.CharField(
                    choices=[
                        ...
                        ("PAYMENT_MODULE_VIEW_LIST", "PAYMENT MODULE VIEW LIST"),
                        ("PAYMENT_MODULE_CREATE", "PAYMENT MODULE CREATE"),
                        ("PAYMENT_MODULE_VIEW_DETAILS", "PAYMENT MODULE VIEW DETAILS"),
                        (
                            "FINANCIAL_SERVICE_PROVIDER_VIEW_LIST_AND_DETAILS",
                            "FINANCIAL SERVICE PROVIDER VIEW LIST AND DETAILS",
                        ),
                        ("FINANCIAL_SERVICE_PROVIDER_VIEW_DETAILS", "FINANCIAL SERVICE PROVIDER VIEW DETAILS"),
                        ("FINANCIAL_SERVICE_PROVIDER_CREATE", "FINANCIAL SERVICE PROVIDER CREATE"),
                        ("FINANCIAL_SERVICE_PROVIDER_UPDATE", "FINANCIAL SERVICE PROVIDER UPDATE"),
                        ("FINANCIAL_SERVICE_PROVIDER_REMOVE", "FINANCIAL SERVICE PROVIDER REMOVE"),
                        ("FINANCIAL_SERVICE_PROVIDER_ACTIVATE", "FINANCIAL SERVICE PROVIDER ACTIVATE"),
                        (
                            "FINANCIAL_SERVICE_PROVIDER_XLSX_TEMPLATE_VIEW_LIST_AND_DETAILS",
                            "FINANCIAL SERVICE PROVIDER XLSX TEMPLATE VIEW LIST AND DETAILS",
                        ),
                        (
                            "FINANCIAL_SERVICE_PROVIDER_XLSX_TEMPLATE_VIEW_DETAILS",
                            "FINANCIAL SERVICE PROVIDER XLSX TEMPLATE VIEW DETAILS",
                        ),
