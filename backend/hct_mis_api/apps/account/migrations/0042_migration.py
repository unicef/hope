# Generated by Django 3.2.13 on 2022-10-05 13:25
            ...
            field=hct_mis_api.apps.account.models.ChoiceArrayField(
                base_field=models.CharField(
                    choices=[
                        ...
                        ("ACCOUNTABILITY_FEEDBACK_VIEW_CREATE", "ACCOUNTABILITY FEEDBACK VIEW CREATE"),
                        ("ACCOUNTABILITY_FEEDBACK_VIEW_LIST", "ACCOUNTABILITY FEEDBACK VIEW LIST"),
                        ("ACCOUNTABILITY_FEEDBACK_VIEW_DETAILS", "ACCOUNTABILITY FEEDBACK VIEW DETAILS"),
                        ("ACCOUNTABILITY_FEEDBACK_VIEW_UPDATE", "ACCOUNTABILITY FEEDBACK VIEW UPDATE"),
                        ("ACCOUNTABILITY_FEEDBACK_MESSAGE_VIEW_CREATE", "ACCOUNTABILITY FEEDBACK MESSAGE VIEW CREATE"),
                    ],
                    max_length=255,
                ),
                blank=True,
