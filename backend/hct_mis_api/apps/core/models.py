...
class BusinessArea(TimeStampedUUIDModel):
    ...
    approval_number = models.PositiveIntegerField(default=0)
    authorization_number = models.PositiveIntegerField(default=0)
    finance_review_number = models.PositiveIntegerField(default=0)
