...
from hct_mis_api.apps.core.attributes_qet_queries import (
    ...
    get_full_name_and_address_query,
...
CORE_FIELDS_ATTRIBUTES = [
    ...
    {
        "id": "9db5a27a-0813-4fb3-8bf6-6378abc2afc8",
        "type": TYPE_SELECT_MANY,
        "name": "id_type",
        "lookup": "documents__type__type",
        "required": False,
        "label": {"English(EN)": "What type of identification document is provided?"},
        "hint": "",
        "choices": [{"label": {"English(EN)": label}, "value": value} for value, label in IDENTIFICATION_TYPE_CHOICE],
        "associated_with": _INDIVIDUAL,
        "xlsx_field": "id_type_i_c",
    },
    {
        "id": "005ad3d6-1ad4-41c9-8132-8d8ceaa93e40",
        "type": TYPE_STRING,
        "name": "employer",
        "lookup": "employer",
        "required": False,
        "label": {"English(EN)": "Indicate the name and address of the main employer"},
        "hint": "",
        "choices": [],
        "associated_with": _HOUSEHOLD,
        "xlsx_field": "employer_h_f",
        "get_query": get_full_name_and_address_query,
    },
]
