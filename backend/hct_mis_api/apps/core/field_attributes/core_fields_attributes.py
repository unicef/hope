...
CORE_FIELDS_ATTRIBUTES = (
    [
        ...
        },
        {
            ...
            "hint": "",
            "choices": [
                {"label": {"English(EN)": label}, "value": value} for value, label in REGISTRATION_METHOD_CHOICES
            ],
            "associated_with": _HOUSEHOLD,
        ...
        },
        {
            ...
            "hint": "",
            "choices": [
                {"label": {"English(EN)": label}, "value": value} for value, label in OBSERVED_DISABILITY_CHOICE
            ],
            "associated_with": _INDIVIDUAL,
