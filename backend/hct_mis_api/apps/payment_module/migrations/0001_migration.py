    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, db_index=True)),
                ('updated_at', models.DateTimeField(auto_now=True, db_index=True)),
                ('status', django_fsm.FSMField(choices=[('OPEN', 'Open'), ('LOCKED', 'Locked'), ('IN_APPROVAL', 'In Approval'), ('IN_AUTHORIZATION', 'In Authorization'), ('IN_REVIEW', 'In Review'), ('APPROVED', 'Approved'), ('ONGOING', 'Ongoing'), ('RECONCILED', 'Reconciled')], db_index=True, default='OPEN', max_length=50)),
