...
class ImportedHouseholdFactory(factory.DjangoModelFactory):
    ...
    female_age_group_0_4_count = factory.fuzzy.FuzzyInteger(3, 8)
    female_age_group_5_12_count = factory.fuzzy.FuzzyInteger(3, 8)
    female_age_group_13_17_count = factory.fuzzy.FuzzyInteger(3, 8)
    ...
    male_age_group_0_4_count = factory.fuzzy.FuzzyInteger(3, 8)
    male_age_group_5_12_count = factory.fuzzy.FuzzyInteger(3, 8)
    male_age_group_13_17_count = factory.fuzzy.FuzzyInteger(3, 8)
    male_age_group_18_59_count = factory.fuzzy.FuzzyInteger(3, 8)
    male_age_group_60_count = factory.fuzzy.FuzzyInteger(3, 8)
    female_age_group_0_4_disabled_count = factory.fuzzy.FuzzyInteger(3, 8)
    female_age_group_5_12_disabled_count = factory.fuzzy.FuzzyInteger(3, 8)
    female_age_group_13_17_disabled_count = factory.fuzzy.FuzzyInteger(3, 8)
    ...
    male_age_group_0_4_disabled_count = factory.fuzzy.FuzzyInteger(3, 8)
    male_age_group_5_12_disabled_count = factory.fuzzy.FuzzyInteger(3, 8)
    male_age_group_13_17_disabled_count = factory.fuzzy.FuzzyInteger(3, 8)
