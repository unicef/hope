...
from hct_mis_api.apps.registration_datahub.services.sri_lanka_flex_registration_service import SriLankaRegistrationService
...
def create_task_for_processing_records(service: Any, rdi_id: "UUID", records_ids: List) -> None:
    if celery_task := service.PROCESS_FLEX_RECORDS_TASK:
        ...
        raise NotImplementedError(f"Not found celery task for processing records in {service}")
