...
class TestGoldenRecordDeduplication(BaseElasticSearchTestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.document1 = Document(type=dt, document_number="ASD123", individual=cls.individuals[0])
    ...
    def test_hard_documents_deduplication(self):
        DeduplicateTask.hard_deduplicate_documents((self.document1, self.document2, self.document3))
