...
class TestGoldenRecordDeduplication(BaseElasticSearchTestCase):
    ...
    def setUpTestData(cls) -> None:
        ...
        dt = DocumentTypeFactory(label="national_id", key="national_id", valid_for_deduplication=True)
        dt_tax_id = DocumentTypeFactory(label="tax_id", key="tax_id", valid_for_deduplication=True)
        dt.save()
