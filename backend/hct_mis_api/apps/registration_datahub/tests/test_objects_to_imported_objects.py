...
# TODO: do we have to remove this one?
...
#         )
#         self.assertEqual(
#             Individual.objects.filter(rdi_merge_status="MERGED").count(),
#             0,
#         )
#         self.assertEqual(
#             IndividualIdentity.objects.filter(rdi_merge_status="MERGED").count(),
#             0,
#         )
#         self.assertEqual(
#             Document.objects.filter(rdi_merge_status="MERGED").count(),
#             0,
#         )
#         self.assertEqual(
#             BankAccountInfo.objects.filter(rdi_merge_status="MERGED").count(),
#             0,
#         )
#         self.assertEqual(
#             IndividualRoleInHousehold.objects.filter(rdi_merge_status="MERGED").count(),
#             0,
#         )
#
...
#         )
#
#         imported_individuals = Individual.objects.all()
...
#         )
#
#         imported_document = Document.objects.first()
#         for field in (
#             "document_number",
#             "photo",
#             "expiry_date",
...
#         )
#
#         imported_identity = IndividualIdentity.objects.first()
#         self.assertEqual(
...
#         )
#
#         imported_bank_account_info = BankAccountInfo.objects.first()
#         for field in (
#             "bank_name",
#             "bank_account_number",
#             "debit_card_number",
...
#             )
#
#         imported_individual_role_in_household = IndividualRoleInHousehold.objects.first()
#         self.assertEqual(
...
#         self._object_count_before_after()
#         self.assertFalse(
#             Household.objects.filter(mis_unicef_id=household_withdrawn.unicef_id).exists(),
#         )
#         self.assertFalse(
#             Individual.objects.filter(mis_unicef_id=individuals[0].unicef_id).exists(),
#         )
#         self.assertFalse(
#             Individual.objects.filter(mis_unicef_id=individuals[1].unicef_id).exists(),
#         )
#         self.assertFalse(
#             Household.objects.filter(mis_unicef_id=household_already_in_program.unicef_id).exists(),
#         )
#         self.assertFalse(
#             Individual.objects.filter(mis_unicef_id=individuals_already_in_program[0].unicef_id).exists(),
#         )
