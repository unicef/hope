# Generated by Django 2.2.8 on 2020-06-04 10:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('entitlement_card_status', models.CharField(choices=[('SUCCESS', 'Sucess'), ('PENDING', 'Pending'), ('ERROR', 'Error')], default='PENDING', max_length=20)),
                ('entitlement_card_issue_date', models.DateField()),
                ('delivery_type', models.CharField(choices=[('CASH', 'Cash'), ('DEPOSIT_TO_CARD', 'Deposit to Card'), ('TRANSFER', 'Transfer')], default='CASH', max_length=20)),
