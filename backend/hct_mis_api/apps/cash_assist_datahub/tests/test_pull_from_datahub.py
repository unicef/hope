...
class TestPullDataFromDatahub(TestCase):
    ...
    def test_pull_data(self, mocker: Any) -> None:
        ...
        # self.assertEqual(cash_plan.program_cycle.start_date, self.dh_cash_plan1.start_date.date())
        # self.assertEqual(cash_plan.program_cycle.end_date, self.dh_cash_plan1.end_date.date())
