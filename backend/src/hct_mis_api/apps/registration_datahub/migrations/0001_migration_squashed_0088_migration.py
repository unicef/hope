    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="registration_datahub.importedhousehold",
                    ),
                ),
            ],
            options={
            ...
            fields=[
                ...
                (
                    ...
                    models.OneToOneField(
                        ...
                        to="registration_datahub.importdata",
                    ),
                ),
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="registration_datahub.agency",
                    ),
                ),
                (
                    "individual",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="identities",
                        to="registration_datahub.importedindividual",
                    ),
                ),
            ],
        ),
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                related_name="individuals",
                to="registration_datahub.registrationdataimportdatahub",
            ),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="documents",
                        to="registration_datahub.importeddocumenttype",
                    ),
                ),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name="data_type",
            field=models.CharField(
                choices=[("XLSX", "XLSX File"), ("JSON", "JSON File")],
                default="XLSX",
                max_length=4,
            ),
        ),
        ...
        migrations.AddField(
            ...
            field=models.DateField(
                default=datetime.datetime(2020, 7, 14, 13, 43, 16, 947)
            ),
            preserve_default=False,
        ),
        migrations.AddField(
            ...
            name="last_registration_date",
            field=models.DateField(
                default=datetime.datetime(2020, 7, 14, 13, 43, 21, 163324)
            ),
            preserve_default=False,
        ),
        migrations.AlterUniqueTogether(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                to="registration_datahub.record",
            ),
        ),
        migrations.AlterField(
            model_name="importdata",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        choices=[("True", "disabled"), ("False", "not disabled")],
                        default="not disabled",
                        max_length=20,
                        null=True,
                    ),
