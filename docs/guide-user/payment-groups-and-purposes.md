...
The **"Create Top-Up Amendment"** button appears on a Top-Up Payment Plan in **Accepted** or **Finished** status when at least one of its payments has been delivered and is not yet covered by another Amendment.
