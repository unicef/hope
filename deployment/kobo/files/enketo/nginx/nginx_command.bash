...
if [[ -e /tmp/enketo_express_secrets/tls.crt ]] && [[ -s /tmp/enketo_express_secrets/tls.crt ]] && \
[[ -e /tmp/enketo_express_secrets/tls.key ]] && [[ -s /tmp/enketo_express_secrets/tls.key ]] ; then
