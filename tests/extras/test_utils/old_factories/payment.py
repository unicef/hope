...
class PaymentVerificationPlanFactory(DjangoModelFactory):
    payment_plan = factory.SubFactory("extras.test_utils.old_factories.payment.PaymentPlanFactory")
...
class PaymentVerificationFactory(DjangoModelFactory):
    payment = factory.SubFactory("extras.test_utils.old_factories.payment.PaymentFactory")
