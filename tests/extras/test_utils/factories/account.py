...
def create_superuser(**kwargs: Any) -> User:
    ...
    email = kwargs.pop("email", "root@root.com")
    first_name = kwargs.pop("first_name", "Root")
    last_name = kwargs.pop("last_name", "Rootkowski")
    partner = kwargs.pop("partner", PartnerFactory(name="UNICEF HQ"))
