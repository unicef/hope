...
class TestSmokeTargeting:
    ...
    def test_smoke_targeting_create_use_filters(
        ...
        page_targeting_create.wait_for_header_text(page_targeting_create.page_header_title, "New Target Population")
    ...
    def test_smoke_targeting_details_page(
        ...
        page_targeting_details.wait_for_header_text(page_targeting_details.page_header_title, create_targeting.name)
