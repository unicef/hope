...
def test_create_household_success(
    ...
    household_data = {
        ...
        "alternate_collector_id": alternate_collector.unicef_id,
        "members": [
...
def test_create_multiple_households_success(
    ...
    payloads = [
        ...
        },
        {
            ...
            "consent_sharing": ["UNICEF", "PRIVATE_PARTNER"],
            "village": "Village 2",
            "head_of_household_id": second_hoh.unicef_id,
            "primary_collector_id": primary_collector.unicef_id,
    ...
    payloads = [
        {
            ...
            "size": -1,
            "head_of_household_id": "NON_EXISTENT_ID",
            "primary_collector_id": "NON_EXISTENT_ID",
            "members": [],
        },
    ]
...
def test_create_household_with_consent_sign_stores_image_file(
    ...
    assert household.consent_sign.name.startswith(
        f"{program.start_date.year}/{program.business_area.slug}/{programme_code}/{programme_code}"
    )
