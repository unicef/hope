...
snapshots[
    "TestAdjudicationTicketPartnerPermission::test_close_ticket_when_partner_does_not_have_admin_area_access 1"
] = {
...
snapshots[
    "TestAdjudicationTicketPartnerPermission::test_close_ticket_when_partner_with_admin_area_access_and_no_selected_program 1"
] = {
    "data": {
        "grievanceStatusChange": {
            "__typename": "GrievanceStatusChangeMutation",
...
snapshots[
    "TestAdjudicationTicketPartnerPermission::test_select_individual_when_partner_does_not_have_admin_area_access 1"
] = {
...
snapshots[
    "TestAdjudicationTicketPartnerPermission::test_select_individual_when_partner_with_admin_area_access_and_no_selected_program 1"
] = {
    "data": {
        "approveNeedsAdjudication": {
            "__typename": "NeedsAdjudicationApproveMutation",
...
snapshots[
    "TestAdjudicationTicketPartnerPermission::test_select_individual_when_partner_with_admin_area_access_with_selectedIndividualId 1"
] = {
    "data": {
        "approveNeedsAdjudication": {
            "__typename": "NeedsAdjudicationApproveMutation",
...
snapshots[
    "TestAdjudicationTicketPartnerPermission::test_select_individual_when_partner_with_admin_area_access_with_selectedIndividualId_incorrect 1"
] = {
    "data": {"approveNeedsAdjudication": None},
    "errors": [
        {
...
snapshots[
    "TestAdjudicationTicketPartnerPermission::test_select_individual_when_partner_with_admin_area_access_with_selected_individual_and_selected_individuals 1"
] = {
    "data": {"approveNeedsAdjudication": None},
    "errors": [
        {
