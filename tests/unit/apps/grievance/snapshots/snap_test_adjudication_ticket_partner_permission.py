...
snapshots[
    "TestAdjudicationTicketPartnerPermission::test_close_ticket_when_partner_does_not_have_permission 1"
] = {
...
snapshots[
    "TestAdjudicationTicketPartnerPermission::test_close_ticket_when_partner_is_unicef 1"
] = {
    "data": {
...
snapshots[
    "TestAdjudicationTicketPartnerPermission::test_close_ticket_when_partner_with_permission 1"
] = {
    "data": {
        "grievanceStatusChange": {
            "__typename": "GrievanceStatusChangeMutation",
...
snapshots[
    "TestAdjudicationTicketPartnerPermission::test_select_individual_when_partner_does_not_have_permission 1"
] = {
...
snapshots[
    "TestAdjudicationTicketPartnerPermission::test_select_individual_when_partner_is_unicef 1"
] = {
    "data": {
...
snapshots[
    "TestAdjudicationTicketPartnerPermission::test_select_individual_when_partner_with_permission 1"
] = {
    "data": {
        "approveNeedsAdjudication": {
            "__typename": "NeedsAdjudicationApproveMutation",
