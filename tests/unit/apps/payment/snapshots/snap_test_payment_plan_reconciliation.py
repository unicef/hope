...
snapshots[
    "TestPaymentPlanReconciliation::test_apply_steficon_rule_with_wrong_payment_plan_status 1"
] = {
...
snapshots[
    "TestPaymentPlanReconciliation::test_apply_steficon_rule_with_wrong_payment_plan_status 2"
] = {
    "data": {"setSteficonRuleOnPaymentPlanPaymentList": None},
    "errors": [
        {
...
snapshots[
    "TestPaymentPlanReconciliation::test_assign_fsp_mutation_payment_plan_wrong_status 1"
] = {
...
snapshots[
    "TestPaymentPlanReconciliation::test_correct_message_displayed_when_file_is_protected 1"
] = {
...
snapshots[
    "TestPaymentPlanReconciliation::test_error_message_when_engine_rule_not_enabled_or_deprecated 1"
] = {
    "data": {"setSteficonRuleOnPaymentPlanPaymentList": None},
    "errors": [
        {
...
snapshots[
    "TestPaymentPlanReconciliation::test_error_message_when_engine_rule_not_enabled_or_deprecated 2"
] = {
    "data": {"setSteficonRuleOnPaymentPlanPaymentList": None},
    "errors": [
        {
...
snapshots[
    "TestPaymentPlanReconciliation::test_export_xlsx_per_fsp_with_auth_code 1"
] = {
    "data": {"exportXlsxPaymentPlanPaymentListPerFsp": None},
    "errors": [
        {
...
snapshots[
    "TestPaymentPlanReconciliation::test_export_xlsx_per_fsp_with_auth_code 2"
] = {
    "data": {
...
snapshots[
    "TestPaymentPlanReconciliation::test_follow_up_pp_entitlements_can_be_changed_with_steficon_rule 1"
] = {
    "data": {
        "setSteficonRuleOnPaymentPlanPaymentList": {
            "paymentPlan": {"unicefId": "PP-0060-23-00000002"}
        }
    }
}

snapshots[
    "TestPaymentPlanReconciliation::test_follow_up_pp_entitlements_updated_with_file 1"
] = {
    "data": {
...
snapshots[
    "TestPaymentPlanReconciliation::test_import_with_wrong_payment_plan_status 1"
] = {
    "data": {"importXlsxPaymentPlanPaymentListPerFsp": None},
    "errors": [
        {
