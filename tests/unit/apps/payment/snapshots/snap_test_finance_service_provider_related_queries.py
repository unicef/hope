...
snapshots[
    "TestFSPRelatedSchema::test_query_all_financial_service_provider_xlsx_templates 1"
] = {
    "data": {
...
snapshots[
    "TestFSPRelatedSchema::test_query_single_financial_service_provider_xlsx_template 1"
] = {
    "data": {
