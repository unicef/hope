...
snapshots[
    "TestDashboardQueries::test_table_total_cash_transferred_by_administrative_area_0_admin2 1"
] = {
    "data": {
...
snapshots[
    "TestDashboardQueries::test_table_total_cash_transferred_by_administrative_area_1_totalCashTransferred 1"
] = {
    "data": {
        "tableTotalCashTransferredByAdministrativeArea": {
            "data": [
...
snapshots[
    "TestDashboardQueries::test_table_total_cash_transferred_by_administrative_area_2_totalHouseholds 1"
] = {
    "data": {
        "tableTotalCashTransferredByAdministrativeArea": {
            "data": [
...
snapshots[
    "TestDashboardQueries::test_table_total_cash_transferred_by_administrative_area_for_people_0_admin2 1"
