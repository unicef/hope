...
snapshots["TestSplitPaymentPlan::test_split_payment_plan_mutation 4"] = {
    "data": {"splitPaymentPlan": None},
    "errors": [
        {"locations": [{"column": 3, "line": 3}], "message": "No payments to split", "path": ["splitPaymentPlan"]}
    ],
}
...
snapshots["TestSplitPaymentPlan::test_split_payment_plan_mutation 6"] = {
    "data": {"splitPaymentPlan": {"paymentPlan": {"status": "ACCEPTED"}}}
}
