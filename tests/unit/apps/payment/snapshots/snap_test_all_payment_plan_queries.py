...
snapshots[
    "TestPaymentPlanQueries::test_fetch_all_payments_for_locked_payment_plan 1"
] = {
    "data": {
        "allPayments": {
            "edgeCount": 1,
...
snapshots["TestPaymentPlanQueries::test_fetch_payment_plan_status_choices 1"] = {
    "data": {
        "paymentPlanStatusChoices": [
            ...
            {"name": "Migration Blocked", "value": "MIGRATION_BLOCKED"},
            {"name": "Migration Failed", "value": "MIGRATION_FAILED"},
...
snapshots[
    "TestPaymentPlanQueries::test_payment_plan_filter_total_households_count_max 1"
] = {
    "data": {
        "allPaymentPlans": {
            "edges": [
...
snapshots[
    "TestPaymentPlanQueries::test_payment_plan_filter_total_households_count_min 1"
] = {
    "data": {
        "allPaymentPlans": {
            "edges": [
...
snapshots[
    "TestPaymentPlanQueries::test_payment_plan_filter_total_households_count_with_valid_phone_no_max_2 1"
] = {
    "data": {
        "allPaymentPlans": {
            "edges": [
...
snapshots[
    "TestPaymentPlanQueries::test_payment_plan_filter_total_households_count_with_valid_phone_no_min_2 1"
] = {
    "data": {
        "allPaymentPlans": {
            "edges": [
...
snapshots[
    "TestPaymentPlanQueries::test_payment_plans_export_download_properties_0_with_permission_api 1"
] = {
    "data": {
        "paymentPlan": {
...
snapshots[
    "TestPaymentPlanQueries::test_payment_plans_export_download_properties_1_without_permission_api 1"
] = {
    "data": {
        "paymentPlan": {
            "canCreateXlsxWithFspAuthCode": True,
...
snapshots[
    "TestPaymentPlanQueries::test_payment_plans_export_download_properties_2_with_permission_xlsx 1"
] = {
    "data": {
        "paymentPlan": {
            "canCreateXlsxWithFspAuthCode": False,
...
snapshots[
    "TestPaymentPlanQueries::test_payment_plans_export_download_properties_3_without_permission_xlsx 1"
] = {
    "data": {
        "paymentPlan": {
            "canCreateXlsxWithFspAuthCode": False,
