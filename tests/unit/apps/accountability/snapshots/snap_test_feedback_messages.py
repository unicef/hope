...
snapshots[
    "TestFeedbackMessages::test_create_feedback_message_1_without_permission 1"
] = {
    "data": {"createFeedbackMessage": None},
    "errors": [
        {
            "locations": [{"column": 7, "line": 3}],
            "message": "Permission Denied: User does not have correct permission.",
            "path": ["createFeedbackMessage"],
        }
    ],
}

snapshots[
    "TestFeedbackMessages::test_feedback_query_shows_feedback_messages_0_with_permission 1"
] = {
    "data": {
        "feedback": {
            "feedbackMessages": {
...
snapshots[
    "TestFeedbackMessages::test_feedback_query_shows_feedback_messages_1_without_permission 1"
] = {
    "data": {"feedback": None},
    "errors": [
        {
