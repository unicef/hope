...
class UserRolesTest(TestCase):
    ...
    def test_user_role_exclude_by_expiry_date(self) -> None:
        ...
        assert Permissions.REPORTING_EXPORT.value not in user_not_unicef_partner.permissions_in_business_area(
            self.business_area_afg.slug
        )
        assert Permissions.REPORTING_EXPORT.value in user_not_unicef_partner.permissions_in_business_area(
        ...
        # empty list
        assert user_not_unicef_partner.permissions_in_business_area(self.business_area_afg.slug) == []
