...
snapshots[
    "TestCreateRegistrationDataImport::test_create_reg_data_import_authenticated 1"
] = {
    "data": {
...
snapshots[
    "TestCreateRegistrationDataImport::test_create_reg_data_import_not_authenticated 1"
] = {
