...
def test_delete_deduplication_set(mock_delete: mock.Mock) -> None:
    ...
    mock_delete.assert_called_once_with("TESTdeduplication_sets/slug/")
...
def test_create_deduplication_set(mock_post: mock.Mock) -> None:
    ...
    mock_post.assert_called_once_with("TESTdeduplication_sets/", dataclasses.asdict(deduplication_set))
...
def test_get_deduplication_set(get_mock: mock.Mock) -> None:
    ...
    get_mock.assert_called_once_with("TESTdeduplication_sets/slug/")
...
def test_bulk_upload_images(mock_post: mock.Mock) -> None:
    ...
    mock_post.assert_has_calls(
        [
            call(
                "TESTdeduplication_sets/slug/images_bulk/",
...
def test_bulk_delete_images(mock_delete: mock.Mock) -> None:
    ...
    mock_delete.assert_called_once_with("TESTdeduplication_sets/slug/images_bulk/")
...
def test_get_duplicates(get_mock: mock.Mock) -> None:
    ...
    get_mock.assert_called_once_with("TESTdeduplication_sets/slug/duplicates/", {"reference_pk": ""})
...
def test_get_duplicates_paginated(get_mock: mock.Mock) -> None:
    ...
    page1 = ({"next": "TESTdeduplication_sets/x/duplicates/?page=2", "results": [{"id": 1}, {"id": 2}]}, 200)
    ...
    get_mock.assert_any_call("TESTdeduplication_sets/slug/duplicates/", {"reference_pk": "1,2,3,4"})
    get_mock.assert_any_call("TESTdeduplication_sets/x/duplicates/?page=2", None)
...
def test_process_deduplication(post_mock: mock.Mock) -> None:
    ...
    post_mock.assert_called_once_with(
        "TESTdeduplication_sets/slug/process/",
...
def test_report_false_positive_duplicate(post_mock: mock.Mock) -> None:
    ...
    post_mock.assert_called_once_with(
        "TESTdeduplication_sets/slug/ignored/filenames/",
        {
            "first": "123",
            "second": "456",
        },
...
def test_report_refused_individuals(post_mock: mock.Mock) -> None:
    ...
    post_mock.assert_called_once_with(
        "TESTdeduplication_sets/slug/approve_or_reject/",
        {
            "action": "approved",
            "targets": ["abc", "def", "ghi"],
        },
