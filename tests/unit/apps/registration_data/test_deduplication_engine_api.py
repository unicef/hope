...
def test_get_group_findings_single_page(get_mock: mock.Mock) -> None:
    ...
    get_mock.assert_called_once_with("TEST/deduplication_set_groups/PROG-1/findings/")
...
def test_get_group_findings_auto_paginates(
    ...
    assert get_mock.call_count == 2
    get_mock.assert_any_call("TEST/deduplication_set_groups/PROG-1/findings/")
    get_mock.assert_any_call("https://dedupe.api/deduplication_set_groups/PROG-1/findings/?page=2")
