...
def rdi_cw(afghanistan: BusinessArea, program: Program) -> RegistrationDataImport:
    return RegistrationDataImportFactory(
        ...
        name="CW RDI",
        correlation_id="cw-corr-detail-1",
    )
...
def test_detail_includes_correlation_id_for_cw_rdi(
...
def test_detail_correlation_id_null_for_legacy_rdi(
    authenticated_client: Any,
...
def test_list_includes_correlation_id(
    authenticated_client: Any,
    rdi_cw: RegistrationDataImport,
    rdi_legacy: RegistrationDataImport,
    url_list: str,
