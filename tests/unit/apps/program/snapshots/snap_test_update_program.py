                ...
                "pduFields": [
                    {
                        ...
                        "pduData": {"numberOfRounds": 1, "roundsNames": ["Round To Be Preserved"], "subtype": "DATE"},
                    },
                    {
                        ...
                        "pduData": {
                            "numberOfRounds": 3,
                            "roundsNames": ["Round 1 To Be Removed", "Round 2 To Be Removed", "Round 3 To Be Removed"],
                            "subtype": "DECIMAL",
                        },
                    },
                    {
...
snapshots["TestUpdateProgram::test_update_program_authenticated_0_with_permissions 1"] = {
    "data": {
        "updateProgram": {
            "program": {
                "beneficiaryGroup": {"name": "Household"},
                "dataCollectingType": {"code": "partial_individuals", "label": "Partial"},
                "name": "updated name",
                "pduFields": [
                    {
                        "label": '{"English(EN)": "PDU Field To Be Preserved"}',
...
snapshots["TestUpdateProgram::test_update_program_incompatible_beneficiary_group 1"] = {
    "data": {
        "updateProgram": {
            "program": None,
            "validationErrors": {
                "__all__": ["Selected combination of data collecting type and beneficiary group is invalid."]
            },
        }
    }
}
