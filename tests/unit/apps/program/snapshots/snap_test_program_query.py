        ...
        "program": {
            ...
            "pduFields": [
                ...
                },
                {
                    ...
                    "pduData": {
                        "numberOfRounds": 2,
                        "roundsNames": ["Round January", "Round February"],
                        "subtype": "STRING",
                    },
                },
                {
                    ...
                    "name": "pdu_field_3",
                    "pduData": {"numberOfRounds": 1, "roundsNames": ["Round *"], "subtype": "DATE"},
                },
                {
                    "label": '{"English(EN)": "PDU Field 4"}',
                    "name": "pdu_field_4",
                    "pduData": {"numberOfRounds": 2, "roundsNames": ["Round A", "Round B"], "subtype": "BOOL"},
                },
            ],
            "status": "ACTIVE",
...
snapshots["TestProgramQuery::test_single_program_query_1_without_permission 1"] = {
    "data": {"program": None},
    "errors": [{"locations": [{"column": 7, "line": 3}], "message": "Permission Denied", "path": ["program"]}],
}
