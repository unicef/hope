...
snapshots['TestUpdateProgramPartners::test_update_program_partners_all_partners_access_refresh_partners_after_update 1'] = {
    'data': {
        'updateProgramPartners': {
            'program': {
                'partnerAccess': 'ALL_PARTNERS_ACCESS',
...
snapshots['TestUpdateProgramPartners::test_update_program_partners_all_partners_access_refresh_partners_after_update 2'] = {
    'data': {
        'updateProgramPartners': {
            'program': {
                'partnerAccess': 'ALL_PARTNERS_ACCESS',
