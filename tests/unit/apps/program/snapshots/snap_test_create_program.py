...
snapshots[
    "TestCreateProgram::test_create_program_authenticated_0_with_permission 1"
] = {
    "data": {
        "createProgram": {
            "program": {
                "administrativeAreasOfImplementation": "Lorem Ipsum",
                "beneficiaryGroup": {"name": "School"},
                "budget": "20000000",
                "cashPlus": True,
                "dataCollectingType": {
                    "active": True,
...
snapshots[
    "TestCreateProgram::test_create_program_authenticated_1_without_permission 1"
] = {
    "data": {"createProgram": None},
    "errors": [
        {
...
snapshots[
    "TestCreateProgram::test_create_program_authenticated_2_with_permission_but_invalid_dates 1"
] = {
    "data": {"createProgram": None},
    "errors": [
        {
...
snapshots[
    "TestCreateProgram::test_create_program_with_dct_social_not_compatible_with_beneficiary_group 1"
] = {
    "data": {
        "createProgram": {
            "program": None,
...
snapshots[
    "TestCreateProgram::test_create_program_with_dct_standard_not_compatible_with_beneficiary_group 1"
] = {
    "data": {
        "createProgram": {
            "program": None,
...
snapshots[
    "TestCreateProgram::test_create_program_with_partners_1_invalid_all_partner_access 1"
] = {
    "data": {"createProgram": None},
    "errors": [
        {
...
snapshots[
    "TestCreateProgram::test_create_program_with_partners_2_invalid_none_partner_access 1"
] = {
    "data": {"createProgram": None},
    "errors": [
        {
...
snapshots[
    "TestCreateProgram::test_create_program_with_partners_all_partners_access 1"
] = {
    "data": {
        "createProgram": {
            "program": {
...
snapshots[
    "TestCreateProgram::test_create_program_with_partners_none_partners_access 1"
] = {
    "data": {
        "createProgram": {
            "program": {
...
snapshots[
    "TestCreateProgram::test_create_program_with_pdu_fields_duplicated_field_names_in_input 1"
] = {
    "data": {"createProgram": None},
    "errors": [
        {
...
snapshots[
    "TestCreateProgram::test_create_program_with_pdu_fields_existing_field_name_in_different_program 1"
] = {
    "data": {
        "createProgram": {
            "program": {
...
snapshots[
    "TestCreateProgram::test_create_program_with_programme_code_greater_than_4_chars 1"
] = {
    "data": {"createProgram": None},
    "errors": [
        {
...
snapshots[
    "TestCreateProgram::test_create_program_with_programme_code_less_than_4_chars 1"
] = {
    "data": {"createProgram": None},
    "errors": [
        {
...
snapshots[
    "TestCreateProgram::test_create_program_with_programme_code_not_within_allowed_characters 1"
] = {
    "data": {"createProgram": None},
    "errors": [
        {
...
snapshots[
    "TestCreateProgram::test_programme_code_should_be_unique_among_the_same_business_area 1"
] = {
    "data": {"createProgram": None},
    "errors": [
        {
