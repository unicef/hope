...
snapshots["TestCashPlanQueries::test_cash_plans_1_all_without_permission 1"] = {
    "data": {"allCashPlans": None},
    "errors": [{"locations": [{"column": 3, "line": 3}], "message": "Permission Denied", "path": ["allCashPlans"]}],
}
...
snapshots["TestCashPlanQueries::test_cash_plans_3_single_without_permission 1"] = {
    "data": {"cashPlan": None},
    "errors": [{"locations": [{"column": 3, "line": 3}], "message": "Permission Denied", "path": ["cashPlan"]}],
}
