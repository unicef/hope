...
snapshots[
    "TestAllProgramsQuery::test_all_programs_query_filter_beneficiary_group 1"
] = {
    "data": {
        "allPrograms": {
            "edges": [{"node": {"name": "Other Program Beneficiary Group 1"}}],
            "totalCount": 1,
        }
    }
}
...
snapshots[
    "TestAllProgramsQuery::test_all_programs_query_filter_beneficiary_group 2"
] = {
    "data": {
        "allPrograms": {
            "edges": [
                ...
                {"node": {"name": "Program with partner access"}},
                {"node": {"name": "Program without partner access"}},
            ],
            "totalCount": 7,
        }
    }
...
snapshots[
    "TestAllProgramsQuery::test_program_can_run_deduplication_and_is_deduplication_disabled 1"
] = {"data": {"canRunDeduplication": True, "isDeduplicationDisabled": True}}

snapshots[
    "TestAllProgramsQuery::test_program_can_run_deduplication_and_is_deduplication_disabled 2"
] = {"data": {"canRunDeduplication": True, "isDeduplicationDisabled": False}}

snapshots[
    "TestAllProgramsQuery::test_program_can_run_deduplication_and_is_deduplication_disabled 3"
] = {"data": {"canRunDeduplication": True, "isDeduplicationDisabled": True}}
