...
snapshots["TestHouseholdQuery::test_household_query_all_for_all_programs 1"] = {
    "data": {
        "allHouseholds": {
            "edges": [
                {"node": {"address": "Lorem Ipsum 1", "countryOrigin": "Poland", "size": 1}},
                {"node": {"address": "Lorem Ipsum 2", "countryOrigin": "Poland", "size": 2}},
                {"node": {"address": "Lorem Ipsum 3", "countryOrigin": "Poland", "size": 3}},
                {"node": {"address": "Lorem Ipsum 4", "countryOrigin": "Poland", "size": 4}},
                {"node": {"address": "Lorem Ipsum 5", "countryOrigin": "Poland", "size": 5}},
                {"node": {"address": "Lorem Ipsum 11", "countryOrigin": "Poland", "size": 11}},
                {"node": {"address": "Lorem Ipsum 14", "countryOrigin": "Poland", "size": 14}},
            ]
        }
    }
...
snapshots["TestHouseholdQuery::test_query_households_by_national_id_no_filter_0_with_permission 1"] = {
    "data": {"allHouseholds": {"edges": [{"node": {"address": "Lorem Ipsum 2", "countryOrigin": "Poland", "size": 2}}]}}
}
