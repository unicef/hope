...
snapshots[
    "TestIndividualQuery::test_query_individuals_by_search_detail_id_filter_with_search_type_0_with_permission 1"
] = {
    "data": {
        "allIndividuals": {
            "edges": [
...
snapshots[
    "TestIndividualQuery::test_query_individuals_by_search_detail_id_filter_with_search_type_1_without_permission 1"
] = {
    "data": {"allIndividuals": None},
    "errors": [{"locations": [{"column": 7, "line": 3}], "message": "Permission Denied", "path": ["allIndividuals"]}],
}
