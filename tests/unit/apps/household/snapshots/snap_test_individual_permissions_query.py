...
snapshots[
    "TestIndividualPermissionsQuery::test_unicef_partner_has_access_for_program 1"
] = {"data": {"individual": {"household": {"admin2": {"pCode": "TEST0101"}}}}}

snapshots[
    "TestIndividualPermissionsQuery::test_unicef_partner_has_access_query_all_programs 1"
] = {"data": {"individual": {"household": {"admin2": {"pCode": "TEST0101"}}}}}
