    ...
    def test_individuals_list(
        ...
        for i, individual in enumerate(
            ...
            assert individual_result["household"] == {
                ...
                "admin3": None,
                "admin4": None,
                "first_registration_date": f"{individual.household.first_registration_date:}",
                "last_registration_date": f"{individual.household.last_registration_date:}",
                "total_cash_received": None,
                "total_cash_received_usd": None,
                "delivered_quantities": [{"currency": "USD", "total_delivered_quantity": "0.00"}],
                "start": individual.household.start.strftime(""),
                "zip_code": None,
...
class TestIndividualDetail:
    ...
    def test_individual_detail(self, create_user_role_with_permissions: Any) -> None:
        ...
        assert data["household"] == {
            ...
            "first_registration_date": f"{self.individual1.household.first_registration_date:}",
            "last_registration_date": f"{self.individual1.household.last_registration_date:}",
            "total_cash_received": None,
            "total_cash_received_usd": None,
            "delivered_quantities": [{"currency": "USD", "total_delivered_quantity": "0.00"}],
            "start": self.individual1.household.start.strftime(""),
            "zip_code": None,
        ...
        assert data["roles_in_households"] == [
            {
                ...
                "household": {
                    ...
                    "first_registration_date": f"{self.household.first_registration_date:}",
                    "last_registration_date": f"{self.household.last_registration_date:}",
                    "total_cash_received": None,
                    "total_cash_received_usd": None,
                    "delivered_quantities": [{"currency": "USD", "total_delivered_quantity": "0.00"}],
                    "start": self.household.start.strftime(""),
                    "zip_code": None,
