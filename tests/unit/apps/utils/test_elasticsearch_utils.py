...
def test_ensure_index_ready_healthy_green(mock_connections):
...
@patch("hope.apps.utils.elasticsearch_utils.connections")
def test_ensure_index_ready_healthy_yellow(mock_connections):
    from hope.apps.utils.elasticsearch_utils import ensure_index_ready
...
@patch("hope.apps.utils.elasticsearch_utils.connections")
def test_ensure_index_ready_red_raises(mock_connections):
    from hope.apps.utils.elasticsearch_utils import ensure_index_ready
