...
class TestCoreUtils(TestCase):
    ...
    def test_get_payment_delivered_quantity_status_and_value(self) -> None:
        ...
        assert get_payment_delivered_quantity_status_and_value(-1, Decimal(10.0)) == (Payment.STATUS_ERROR, None)
        assert get_payment_delivered_quantity_status_and_value(0, Decimal(10.0)) == (Payment.STATUS_NOT_DISTRIBUTED, 0)
        assert get_payment_delivered_quantity_status_and_value(5.0, Decimal(10.0)) == (
            Payment.STATUS_DISTRIBUTION_PARTIAL,
            Decimal(5.0),
        )
        assert get_payment_delivered_quantity_status_and_value(10.0, Decimal(10.0)) == (
