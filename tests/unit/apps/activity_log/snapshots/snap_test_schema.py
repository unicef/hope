            ...
            "edges": [
                {
                    ...
                    "node": {
                        ...
                        "user": {"__typename": "UserNode", "firstName": "First", "lastName": "Last"},
                    },
                },
                {
                    "__typename": "LogEntryNodeEdge",
...
snapshots["TestLogEntriesQueries::test_all_logs_queries_without_perms 1"] = {
    "data": {"allLogEntries": None},
    "errors": [{"locations": [{"column": 3, "line": 3}], "message": "Permission Denied", "path": ["allLogEntries"]}],
}
