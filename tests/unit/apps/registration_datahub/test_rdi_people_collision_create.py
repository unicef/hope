...
class TestRdiXlsxPeople(TestCase):
    ...
    def setUpTestData(cls) -> None:
        ...
        content = Path(f"{settings.TESTS_ROOT}/apps/registration_datahub/test_file/rdi_people_test_collision.xlsx").read_bytes()
        file = File(BytesIO(content), name="rdi_people_test_collision.xlsx")
        ...
        cls.program = ProgramFactory(status=Program.ACTIVE, data_collecting_type__type=DataCollectingType.Type.SOCIAL,collision_detection_enabled=True,collision_detector="hct_mis_api.apps.program.collision_detectors.IdentificationKeyCollisionDetector")
