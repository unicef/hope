...
class TestNigeriaPeopleRegistrationService(TestCase):
                    ...
                    "individual-details": [
                        {
                            ...
                            "confirm_phone_no": "+2340123456789",
    ...
    def test_import_data_to_datahub(self) -> None:
        ...
        self.assertEqual(household.size, 1)
        ...
        self.assertEqual(primary_collector.phone_no, "+2340123456789")
        self.assertEqual(primary_collector.sex, MALE)
        self.assertEqual(primary_collector.email, "gfranco@unicef.org")
        self.assertEqual(primary_collector.phone_no_alternative, "+2340123456789")
