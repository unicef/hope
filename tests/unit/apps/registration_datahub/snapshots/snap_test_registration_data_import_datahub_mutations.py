...
snapshots[
    "TestRegistrationDataImportDatahubMutations::test_registration_data_import_create_0_with_permission 1"
] = {
    "data": {
...
snapshots[
    "TestRegistrationDataImportDatahubMutations::test_registration_data_import_create_1_without_permission 1"
] = {
...
snapshots[
    "TestRegistrationDataImportDatahubMutations::test_registration_data_import_create_validate_import_data 1"
] = {
    "data": {"registrationXlsxImport": None},
    "errors": [
        {
...
snapshots[
    "TestRegistrationDataImportDatahubMutations::test_save_kobo_project_import_data_async_0_with_permission 1"
] = {
    "data": {
...
snapshots[
    "TestRegistrationDataImportDatahubMutations::test_save_kobo_project_import_data_async_1_without_permission 1"
] = {
    "data": {"saveKoboImportDataAsync": None},
    "errors": [
        {
            "locations": [{"column": 7, "line": 8}],
            "message": "Permission Denied: User does not have correct permission.",
            "path": ["saveKoboImportDataAsync"],
        }
    ],
}
