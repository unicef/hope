...
class TestRdiXlsxCreateTask(TestCase):
    ...
    def test_create_bank_account(self) -> None:
        ...
        assert bank_account_info.bank_name == "Bank testowy"
        assert bank_account_info.bank_account_number == "PL70 1410 2006 0000 3200 0926 4671"
        assert bank_account_info.debit_card_number == "5241 6701 2345 6789"
