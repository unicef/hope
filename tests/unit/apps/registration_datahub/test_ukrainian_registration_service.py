...
class TestUkrainianRegistrationService(BaseTestUkrainianRegistrationService):
    ...
    def test_import_data_to_datahub(self) -> None:
        ...
        assert PendingBankAccountInfo.pending_objects.count() == 3
        bank_acc_info = PendingBankAccountInfo.pending_objects.get(bank_account_number="333123321321")
        assert bank_acc_info.account_holder_name == "Test Holder Name 333"
        assert bank_acc_info.bank_branch_name == "Branch Name 333"
        assert (
