export const PERMISSIONS = {
  ...
  // Payment Module
  PM_PAYMENT_MODULE_VIEW_LIST: 'PM_PAYMENT_MODULE_VIEW_LIST',
  PM_PAYMENT_MODULE_CREATE: 'PM_PAYMENT_MODULE_CREATE',
  PM_PAYMENT_MODULE_VIEW_DETAILS: 'PM_PAYMENT_MODULE_VIEW_DETAILS',
  PM_PAYMENT_MODULE_IMPORT_XLSX_WITH_ENTITLEMENTS:
    'PM_PAYMENT_MODULE_IMPORT_XLSX_WITH_ENTITLEMENTS',
  PM_PAYMENT_MODULE_APPLY_RULE_ENGINE_FORMULA_WITH_ENTITLEMENTS:
    'PM_PAYMENT_MODULE_APPLY_RULE_ENGINE_FORMULA_WITH_ENTITLEMENTS',
  PM_FINANCIAL_SERVICE_PROVIDER_VIEW_LIST_AND_DETAILS:
    'PM_FINANCIAL_SERVICE_PROVIDER_VIEW_LIST_AND_DETAILS',
  PM_FINANCIAL_SERVICE_PROVIDER_VIEW_DETAILS:
    'PM_FINANCIAL_SERVICE_PROVIDER_VIEW_DETAILS',
  PM_FINANCIAL_SERVICE_PROVIDER_CREATE: 'PM_FINANCIAL_SERVICE_PROVIDER_CREATE',
  PM_FINANCIAL_SERVICE_PROVIDER_UPDATE: 'PM_FINANCIAL_SERVICE_PROVIDER_UPDATE',
  PM_FINANCIAL_SERVICE_PROVIDER_REMOVE: 'PM_FINANCIAL_SERVICE_PROVIDER_REMOVE',
  PM_FINANCIAL_SERVICE_PROVIDER_ACTIVATE:
    'PM_FINANCIAL_SERVICE_PROVIDER_ACTIVATE',
  PM_FINANCIAL_SERVICE_PROVIDER_XLSX_TEMPLATE_VIEW_LIST_AND_DETAILS:
    'PM_FINANCIAL_SERVICE_PROVIDER_XLSX_TEMPLATE_VIEW_LIST_AND_DETAILS',
  PM_FINANCIAL_SERVICE_PROVIDER_XLSX_TEMPLATE_VIEW_DETAILS:
    'PM_FINANCIAL_SERVICE_PROVIDER_XLSX_TEMPLATE_VIEW_DETAILS',
