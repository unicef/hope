export const PERMISSIONS = {
  ...
  GRIEVANCES_APPROVE_DATA_CHANGE_AS_OWNER:
    'GRIEVANCES_APPROVE_DATA_CHANGE_AS_OWNER',
  GRIEVANCES_UNDO_APPROVED_DATA_CHANGE: 'GRIEVANCES_UNDO_APPROVED_DATA_CHANGE',
  GRIEVANCES_UNDO_APPROVED_DATA_CHANGE_AS_CREATOR:
    'GRIEVANCES_UNDO_APPROVED_DATA_CHANGE_AS_CREATOR',
  GRIEVANCES_UNDO_APPROVED_DATA_CHANGE_AS_OWNER:
    'GRIEVANCES_UNDO_APPROVED_DATA_CHANGE_AS_OWNER',
