export const PERMISSIONS = {
  ...
  // Payment Module
  PAYMENT_MODULE_VIEW_LIST: 'PAYMENT_MODULE_VIEW_LIST',
  PAYMENT_MODULE_CREATE: 'PAYMENT_MODULE_CREATE',
  PAYMENT_MODULE_VIEW_DETAILS: 'PAYMENT_MODULE_VIEW_DETAILS',
  PAYMENT_MODULE_IMPORT_XLSX_WITH_ENTITLEMENTS:
    'PAYMENT_MODULE_IMPORT_XLSX_WITH_ENTITLEMENTS',
  PAYMENT_MODULE_APPLY_RULE_ENGINE_FORMULA_WITH_ENTITLEMENTS:
    'PAYMENT_MODULE_APPLY_RULE_ENGINE_FORMULA_WITH_ENTITLEMENTS',
  FINANCIAL_SERVICE_PROVIDER_VIEW_LIST_AND_DETAILS:
    'FINANCIAL_SERVICE_PROVIDER_VIEW_LIST_AND_DETAILS',
  FINANCIAL_SERVICE_PROVIDER_VIEW_DETAILS:
    'FINANCIAL_SERVICE_PROVIDER_VIEW_DETAILS',
  FINANCIAL_SERVICE_PROVIDER_CREATE: 'FINANCIAL_SERVICE_PROVIDER_CREATE',
  FINANCIAL_SERVICE_PROVIDER_UPDATE: 'FINANCIAL_SERVICE_PROVIDER_UPDATE',
  FINANCIAL_SERVICE_PROVIDER_REMOVE: 'FINANCIAL_SERVICE_PROVIDER_REMOVE',
  FINANCIAL_SERVICE_PROVIDER_ACTIVATE: 'FINANCIAL_SERVICE_PROVIDER_ACTIVATE',
