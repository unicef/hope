...
import { EditEnrollment } from '../../../components/enrollment/EditEnrollment/EditEnrollment';
...
export const EditEnrollmentPage = (): React.ReactElement => {
  const { id } = useParams();
  ...
  return <EditEnrollment targetPopulation={targetPopulation} />;
};
