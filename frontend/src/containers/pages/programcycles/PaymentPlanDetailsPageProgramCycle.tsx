...
import { PaymentPlanDetailsProgramCycleHeader } from '../../../components/paymentmodule/PaymentPlanDetails/PaymentPlanDetailsHeader/PaymentPlanDetailsProgramCycleHeader';

export const PaymentPlanDetailsPageProgramCycle = (): React.ReactElement => {
  ...
  return (
    <Box display='flex' flexDirection='column'>
      <PaymentPlanDetailsProgramCycleHeader
