...
import { FollowUpPaymentPlanDetailsHeaderProgramCycle } from '../../../components/paymentmodule/FollowUpPaymentPlanDetails/FollowUpPaymentPlanDetailsHeader/FollowUpPaymentPlanDetailsHeaderProgramCycle';

export const FollowUpPaymentPlanDetailsPageProgramCycle = (): React.ReactElement => {
  ...
  return (
    <>
      <FollowUpPaymentPlanDetailsHeaderProgramCycle
        baseUrl={baseUrl}
