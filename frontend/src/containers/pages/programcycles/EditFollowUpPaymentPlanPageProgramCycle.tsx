...
import { EditPaymentPlanHeaderProgramCycle } from '../../../components/paymentmodule/EditPaymentPlan/EditPaymentPlanHeader/EditPaymentPlanHeaderProgramCycle';
...
export const EditFollowUpPaymentPlanPageProgramCycle = (): React.ReactElement => {
    ...
    >
      {({ submitForm, values }) => (
        <Form>
          ...
          <EditPaymentPlanHeaderProgramCycle
