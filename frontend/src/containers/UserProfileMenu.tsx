...
export function UserProfileMenu({
  ...
  return (
    <>
      <UserProfileButton ref={anchorRef} onClick={handleToggle} data-cy='menu-btn-user-profile'>
            ...
            <Paper>
              <ClickAwayListener onClickAway={handleClose}>
                ...
                >
                  ...
                  <MenuItem onClick={handleLogout} data-cy='menu-item-logout'>Logout</MenuItem>
                </MenuList>
              </ClickAwayListener>
            </Paper>
          </Grow>
