...
export const generateAdminRedirect = (url: string) => {
    ...
    switch (urlPathSwitch) {
      ...
      case 'payment-verification/payment-plan':
        return `${adminBaseUrl}/payment/paymentverificationplan/${decodedUUID}/change`;
      case 'verification/payment':
        return `${adminBaseUrl}/payment/paymentverification/${decodedUUID}/change`;
