...
interface PaymentPlanDetailsProgramCycleHeaderProps {
  baseUrl: string;
  permissions: string[];
  paymentPlan: PaymentPlanQuery['paymentPlan'];
}

export const PaymentPlanDetailsProgramCycleHeader = ({
  baseUrl,
  permissions,
  paymentPlan,
}: PaymentPlanDetailsProgramCycleHeaderProps): React.ReactElement => {
