...
interface CreateEnrollmentHeaderProps {
...
export function CreateEnrollmentHeader({
  handleSubmit,
  values,
  businessArea,
  permissions,
  loading,
}: CreateEnrollmentHeaderProps): React.ReactElement {
