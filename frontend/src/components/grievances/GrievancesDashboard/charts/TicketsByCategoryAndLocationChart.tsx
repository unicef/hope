...
interface TicketsByCategoryAndLocationChartProps {
  data?: GlobalAreaChartsQuery['chartTotalTransferredCashByCountry'];
}

export const TicketsByCategoryAndLocationChart = ({
  data,
}: TicketsByCategoryAndLocationChartProps): React.ReactElement => {
