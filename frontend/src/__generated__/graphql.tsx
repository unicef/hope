...
export type CashPlanNode = Node & {
  ...
  verifications: Array<CashPlanPaymentVerificationNode>,
};
...
export type CashPlanPaymentVerificationNode = {
...
export const AllCashPlansDocument = gql`
    query AllCashPlans($program: ID, $after: String, $before: String, $first: Int, $last: Int, $orderBy: String, $search: String, $assistanceThrough: String, $deliveryType: String) {
  allCashPlans(program: $program, after: $after, before: $before, first: $first, last: $last, orderBy: $orderBy, search: $search, assistanceThrough: $assistanceThrough, deliveryType: $deliveryType) {
    pageInfo {
      hasNextPage
      hasPreviousPage
      startCursor
...
export type CashPlanNodeResolvers<ContextType = any, ParentType extends ResolversParentTypes['CashPlanNode'] = ResolversParentTypes['CashPlanNode']> = {
  ...
  verifications?: Resolver<Array<ResolversTypes['CashPlanPaymentVerificationNode']>, ParentType, ContextType>,
};
