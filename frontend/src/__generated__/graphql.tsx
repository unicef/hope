    ...
    programs: { __typename?: 'ProgramNodeConnection' } & {
      edges: Array<
        Maybe<
          { __typename?: 'ProgramNodeEdge' } & {
            node: Maybe<
              { __typename?: 'ProgramNode' } & Pick<ProgramNode, 'name'>
            >;
          }
        >
      >;
...
export type MeQuery = { __typename?: 'Query' } & {
  me: Maybe<
    ...
    > & {
        businessAreas: { __typename?: 'BusinessAreaNodeConnection' } & {
          edges: Array<
            Maybe<
              { __typename?: 'BusinessAreaNodeEdge' } & {
                node: Maybe<
  ...
  allFieldsAttributes: Maybe<
    Array<
      Maybe<
        { __typename?: 'FieldAttributeNode' } & Pick<
          FieldAttributeNode,
          'isFlexField' | 'id' | 'type' | 'name' | 'labelEn' | 'hint'
        > & {
            labels: Maybe<
              Array<
                Maybe<
...
> = {
  ...
  businessArea?: Resolver<
    ResolversTypes['BusinessAreaNode'],
    ParentType,
    ContextType
  >;
...
> = {
  ...
  >;
  unicefId?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  deduplicationStatus?: Resolver<
    ResolversTypes['IndividualDeduplicationStatus'],
    ParentType,
    ContextType
  >;
  deduplicationResults?: Resolver<
    Maybe<Array<Maybe<ResolversTypes['DeduplicationResultNode']>>>,
    ParentType,
    ContextType
  >;
...
> = {
  ...
  approveTargetPopulation?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<MutationsApproveTargetPopulationArgs, 'id' | 'programId'>
  >;
...
> = {
  ...
  businessAreas?: Resolver<
    ResolversTypes['BusinessAreaNodeConnection'],
    ParentType,
    ContextType,
