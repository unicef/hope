...
export type HouseholdDetailedFragment = { __typename?: 'HouseholdNode' } & Pick<
  HouseholdNode,
  'countryOrigin' | 'country' | 'flexFields'
> & {
    individuals: { __typename?: 'IndividualNodeConnection' } & Pick<
      IndividualNodeConnection,
      'totalCount'
          ...
          Maybe<
            ...
            > & {
                node: Maybe<
                  { __typename?: 'GrievanceTicketNode' } & Pick<
                    GrievanceTicketNode,
                    'id' | 'status' | 'category' | 'createdAt' | 'userModified'
                  > & {
                      assignedTo: Maybe<
                        { __typename?: 'UserNode' } & Pick<
                          UserNode,
...
> = {
  ...
  grievanceticketSet?: Resolver<
    ...
    ParentType,
    ContextType,
    GrievanceTicketNodeGrievanceticketSetArgs
  >;
...
> = {
  ...
  consentSharing?: Resolver<
    ResolversTypes['HouseholdConsentSharing'],
    ParentType,
    ContextType
  >;
...
> = {
  ...
  pregnant?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  observedDisability?: Resolver<
    ResolversTypes['IndividualObservedDisability'],
    ParentType,
    ContextType
  >;
  seeingDisability?: Resolver<
