import { UpdateGrievanceDocument } from '../../src/__generated__/graphql';

export const fakeApolloUpdateGrievanceDetailsPaymentVerificationMutation = [
  {
    request: {
      query: UpdateGrievanceDocument,
      variables: {
        approveStatus: false,
        grievanceTicketId:
