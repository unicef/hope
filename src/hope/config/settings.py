...
BITCASTER_EVENT_ALLOWLIST = env("BITCASTER_EVENT_ALLOWLIST")
BITCASTER_REQUEST_TIMEOUT = env("BITCASTER_REQUEST_TIMEOUT")
...
FLAGS = {
    ...
    "BITCASTER_ENABLED": [{"condition": "boolean", "value": False}],
}
