...
class RdiXlsxPeopleCreateTask(RdiXlsxCreateTask):
    ...
    def _dispatch_people_field(
        self, header: str, cell: object, cell_value: object, current_field: dict[str, Any], obj_to_create: object
    ) -> None:
        if header in self.complex_fields[self.sheet_title]:
            ...
            self._process_flex_field(  # type: ignore[no-untyped-call]
                cell,
                cell_value,
                self.complex_types,
                current_field,
    ...
    def _process_flex_field(self, cell, cell_value, complex_types, current_field, header, **kwargs):  # type: ignore[no-untyped-def, override]
    ...
    def _process_complex_fields_value(self, current_field: dict[str, Any], obj_to_create: Any, value: object) -> None:
        if value is not None:
            setattr(
                obj_to_create,
                current_field["name"],
    ...
    def _set_index_id(self, cell_value: str, header: str) -> None:
