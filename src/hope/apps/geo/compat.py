...
from hope.models import Country  # pragma: no cover
...
class GeoCountryField(models.CharField):
    ...
    def get_choices(
        ...
        blank_choice: list[tuple[Any, Any]] | None = None,
        *args: Any,
        **kwargs: Any,
    ) -> list[Any]:
        ...
        if self.multiple:
            include_blank = False
        return super().get_choices(*args, **kwargs, include_blank=include_blank, blank_choice=blank_choice)
