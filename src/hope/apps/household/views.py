...
from hope.models import Household, PendingDocument, PendingHousehold, PendingIndividual
...
def get_household(detail_id: str, business_area_code: str | None) -> PendingHousehold | Household | None:
