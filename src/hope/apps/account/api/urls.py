...
from hope.apps.account.api.views import GroupViewSet, PartnerViewSet, UserViewSet
...
business_area_nested_router.register("partners", PartnerViewSet, basename="partners")
