            ...
            field=hope.apps.account.fields.ChoiceArrayField(
                base_field=models.CharField(
                    choices=[
                        ...
                        ("RDI_WEBHOOK_DEDUPLICATION", "RDI WEBHOOK DEDUPLICATION"),
                        ("GENERIC_IMPORT_DATA", "GENERIC IMPORT DATA"),
                        (
                        ...
                        (
                            ...
                            "PM SYNC PAYMENT PLAN WITH PG",
                        ),
                        ("PM_SYNC_PAYMENT_WITH_PG", "PM SYNC PAYMENT WITH PG"),
                        ("PM_CLOSE_FINISHED", "PM CLOSE FINISHED"),
                        ("PM_MARK_READY_FOR_CLOSURE", "PM MARK READY FOR CLOSURE"),
                        ("PM_ABORT", "PM ABORT"),
                        ("PM_REACTIVATE_ABORT", "PM REACTIVATE ABORT"),
                        ("PM_CUSTOM_EXCHANGE_RATE", "PM CUSTOM EXCHANGE RATE"),
                        (
                        ...
                        (
                            "PM_PAYMENT_PLAN_GROUP_VIEW_LIST",
                            "PM PAYMENT PLAN GROUP VIEW LIST",
                        ),
                        (
                            "PM_PAYMENT_PLAN_GROUP_VIEW_DETAIL",
                            "PM PAYMENT PLAN GROUP VIEW DETAIL",
                        ),
                        (
                            "PM_PAYMENT_PLAN_GROUP_CREATE",
                            "PM PAYMENT PLAN GROUP CREATE",
                        ),
                        (
                            "PM_PAYMENT_PLAN_GROUP_UPDATE",
                            "PM PAYMENT PLAN GROUP UPDATE",
                        ),
                        (
                        ...
                        ("RECEIVE_PARSED_WU_QCF", "RECEIVE PARSED WU QCF"),
                        ("RECEIVE_PP_OVERDUE_EMAIL", "RECEIVE PP OVERDUE EMAIL"),
                        ...
                        (
                            ...
                            "GRIEVANCES VIEW INDIVIDUALS DETAILS AS OWNER",
                        ),
                        ...
                        (
                            ...
                            "GRIEVANCES APPROVE PAYMENT VERIFICATION AS OWNER",
                        ),
                        ...
                        ("PDU_ONLINE_SAVE_DATA", "PDU ONLINE SAVE DATA"),
                        ("PDU_ONLINE_APPROVE", "PDU ONLINE APPROVE"),
                        ("PDU_ONLINE_MERGE", "PDU ONLINE MERGE"),
                        ...
                        (
                            ...
                            "ACCOUNTABILITY COMMUNICATION MESSAGE VIEW LIST",
                        ),
                        (
                            "ACCOUNTABILITY_COMMUNICATION_MESSAGE_VIEW_DETAILS",
                            "ACCOUNTABILITY COMMUNICATION MESSAGE VIEW DETAILS",
                        ),
                        (
                            "ACCOUNTABILITY_COMMUNICATION_MESSAGE_VIEW_CREATE",
                            "ACCOUNTABILITY COMMUNICATION MESSAGE VIEW CREATE",
                        ),
                        (
                        ...
                        ("SEARCH_BUSINESS_AREAS", "SEARCH BUSINESS AREAS"),
                    ],
                    max_length=255,
                ),
                blank=True,
