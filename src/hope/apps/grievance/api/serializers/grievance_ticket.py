...
class AddIndividualDataSerializer(serializers.Serializer):
    ...
    full_name_local = serializers.CharField(required=False)
    given_name_local = serializers.CharField(required=False)
    middle_name_local = serializers.CharField(required=False)
    family_name_local = serializers.CharField(required=False)
