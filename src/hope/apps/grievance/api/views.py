...
class GrievanceTicketGlobalViewSet(
    ...
    def _validate_status_change_preconditions(
        self, user: "AbstractUser", grievance_ticket: GrievanceTicket, new_status: int, notifications: list[Any]
    ) -> None:
    ...
    def _build_status_change_notifications(
        self, user: object, old_ticket: GrievanceTicket, ticket: GrievanceTicket, notifications: list[Any]
    ) -> None:
