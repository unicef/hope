...
class HistoryExchangeRate:
    ...
    def is_valid(self, dispersion_date: date | None) -> bool:
...
class SingleExchangeRate:
    ...
    def get_exchange_rate_by_dispersion_date(self, dispersion_date: date | None) -> float | None:
...
class ExchangeRates:
    ...
    def get_exchange_rate_for_currency_code(
        self, currency_code: str | None, dispersion_date: date | None
    ) -> float | None:
