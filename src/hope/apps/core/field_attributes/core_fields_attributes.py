...
CORE_FIELDS_ATTRIBUTES = [
    ...
    },
    {
        ...
        "label": {"English(EN)": "Collector phone number"},
        "hint": "Whether the household's collector has a valid (primary or alternative) phone number",
        "required": False,
        "choices": [
            {"label": {"English(EN)": "Has a valid phone number"}, "value": True},
            {"label": {"English(EN)": "Does not have a valid phone number"}, "value": False},
        ],
        "associated_with": _HOUSEHOLD,
