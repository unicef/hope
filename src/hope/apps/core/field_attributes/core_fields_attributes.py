...
CORE_FIELDS_ATTRIBUTES = [
    ...
    {
        "id": "248b358f-ea96-4794-941b-986af9d8ad5e",
        "type": TYPE_STRING,
        "name": "full_name_local",
        "lookup": "full_name_local",
        "required": False,
        "label": {"English(EN)": "Full name local"},
        "hint": "",
        "choices": [],
        "associated_with": _INDIVIDUAL,
        "xlsx_field": "full_name_local_i_c",
        "scope": [
            Scope.GLOBAL,
            Scope.TARGETING,
            Scope.KOBO_IMPORT,
    ...
    {
        "id": "ee311eb5-c0af-4d19-a74e-7ad504260034",
        "type": TYPE_STRING,
        "name": "given_name_local",
        "lookup": "given_name_local",
        "required": False,
        "label": {"English(EN)": "Given name local"},
        "hint": "",
        "choices": [],
        "associated_with": _INDIVIDUAL,
        "xlsx_field": "given_name_local_i_c",
        "scope": [
            Scope.GLOBAL,
            Scope.TARGETING,
            Scope.KOBO_IMPORT,
    ...
    {
        "id": "f307f3ad-01ed-4465-87bf-b4952c85bdc0",
        "type": TYPE_STRING,
        "name": "middle_name_local",
        "lookup": "middle_name_local",
        "required": False,
        "label": {"English(EN)": "Middle name(s) local"},
        "hint": "",
        "choices": [],
        "associated_with": _INDIVIDUAL,
        "xlsx_field": "middle_name_local_i_c",
        "scope": [
            Scope.GLOBAL,
            Scope.TARGETING,
            Scope.KOBO_IMPORT,
    ...
    {
        "id": "a88bcf60-4b3e-4bcb-bef5-7c8eb478e5e8",
        "type": TYPE_STRING,
        "name": "family_name_local",
        "lookup": "family_name_local",
        "required": False,
        "label": {"English(EN)": "Family name local"},
        "hint": "",
        "choices": [],
        "associated_with": _INDIVIDUAL,
        "xlsx_field": "family_name_local_i_c",
        "scope": [
            Scope.GLOBAL,
            Scope.TARGETING,
            Scope.KOBO_IMPORT,
