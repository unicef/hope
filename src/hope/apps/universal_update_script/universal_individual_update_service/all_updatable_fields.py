...
individual_fields: dict[str, tuple[str, Any, Any]] = {
    ...
    "full_name_latin": ("full_name_latin", validate_latin_name, handle_latin_name_field),
    "given_name_latin": ("given_name_latin", validate_latin_name, handle_latin_name_field),
    "middle_name_latin": ("middle_name_latin", validate_latin_name, handle_latin_name_field),
    "family_name_latin": ("family_name_latin", validate_latin_name, handle_latin_name_field),
