...
class GenericRegistrationService(BaseRegistrationService):
    ...
    default_mapping = {
        ...
        "individuals": {
            ...
            "given_name_local_i_c": "individual.given_name_local",
            "middle_name_local_i_c": "individual.middle_name_local",
            "family_name_local_i_c": "individual.family_name_local",
            "full_name_local_i_c": "individual.full_name_local",
