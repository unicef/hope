...
import { adjustHeadCells, formatCurrencyWithSymbol, householdStatusToColor } from '@utils/utils';
...
export const HouseholdTableRest = ({
  filter,
  canViewDetails,
  ...
  const { data, isLoading, error } = useQuery({
    ...
    queryFn: () => RestService.restBusinessAreasProgramsHouseholdsList(queryVariables),
  });
