...
export const EditPeopleFollowUpSetUpFspPage = (): ReactElement => {
  ...
  return (
    <UniversalErrorBoundary
      ...
      beforeCapture={(scope) => {
        ...
        scope.setTag('component', 'EditPeopleFollowUpSetUpFspPage.tsx');
      }}
      componentName="EditPeopleFollowUpSetUpFspPage"
    >
