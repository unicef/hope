export const PERMISSIONS = {
  ...
  // Population
  HOUSEHOLD_MEMBERS_VIEW_LIST: 'HOUSEHOLD_MEMBERS_VIEW_LIST',
  ...
  PM_PROGRAMME_CYCLE_VIEW_LIST: 'PM_PROGRAMME_CYCLE_VIEW_LIST',
  PM_PROGRAMME_CYCLE_VIEW_DETAILS: 'PM_PROGRAMME_CYCLE_VIEW_DETAILS',
  PM_PROGRAMME_CYCLE_CREATE: 'PM_PROGRAMME_CYCLE_CREATE',
  PM_PROGRAMME_CYCLE_UPDATE: 'PM_PROGRAMME_CYCLE_UPDATE',
  PM_PROGRAMME_CYCLE_DELETE: 'PM_PROGRAMME_CYCLE_DELETE',
  PM_VIEW_PAYMENT_LIST: 'PM_VIEW_PAYMENT_LIST',
  PM_PAYMENT_PLAN_GROUP_VIEW_LIST: 'PM_PAYMENT_PLAN_GROUP_VIEW_LIST',
  PM_PAYMENT_PLAN_GROUP_VIEW_DETAIL: 'PM_PAYMENT_PLAN_GROUP_VIEW_DETAIL',
  PM_PAYMENT_PLAN_GROUP_CREATE: 'PM_PAYMENT_PLAN_GROUP_CREATE',
  PM_PAYMENT_PLAN_GROUP_UPDATE: 'PM_PAYMENT_PLAN_GROUP_UPDATE',
  PM_PAYMENT_PLAN_GROUP_DELETE: 'PM_PAYMENT_PLAN_GROUP_DELETE',

  PM_DOWNLOAD_FSP_AUTH_CODE: 'PM_DOWNLOAD_FSP_AUTH_CODE',
  PM_SEND_XLSX_PASSWORD: 'PM_SEND_XLSX_PASSWORD',
  PM_ASSIGN_FUNDS_COMMITMENTS: 'PM_ASSIGN_FUNDS_COMMITMENTS',
  PM_CUSTOM_EXCHANGE_RATE: 'PM_CUSTOM_EXCHANGE_RATE',
  ...
  // Payment Module
  PM_ABORT: 'PM_ABORT',
  PM_REACTIVATE_ABORT: 'PM_REACTIVATE_ABORT',
  ...
  PM_ACCEPTANCE_PROCESS_FINANCIAL_REVIEW:
    'PM_ACCEPTANCE_PROCESS_FINANCIAL_REVIEW',
  PM_ACCEPTANCE_PROCESS_REJECT: 'PM_ACCEPTANCE_PROCESS_REJECT',
  ...
  PM_SEND_TO_PAYMENT_GATEWAY: 'PM_SEND_TO_PAYMENT_GATEWAY',
  PM_SPLIT: 'PM_SPLIT',
  ...
  PM_VIEW_FSP_AUTH_CODE: 'PM_VIEW_FSP_AUTH_CODE',
  ...
  PAYMENT_VIEW_LIST_MANAGERIAL_RELEASED:
    'PAYMENT_VIEW_LIST_MANAGERIAL_RELEASED',
  // Grievances
  GRIEVANCES_VIEW_DETAILS: 'GRIEVANCES_VIEW_DETAILS',
  GRIEVANCES_VIEW_LIST: 'GRIEVANCES_VIEW_LIST',
  ...
  GRIEVANCES_VIEW_BIOMETRIC_RESULTS: 'GRIEVANCES_VIEW_BIOMETRIC_RESULTS',
  ...
  GRIEVANCES_FEEDBACK_VIEW_UPDATE: 'GRIEVANCES_FEEDBACK_VIEW_UPDATE',
  ...
  // Country Search
  SEARCH_BUSINESS_AREAS: 'SEARCH_BUSINESS_AREAS',
};
