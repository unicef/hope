...
// Kept apart because sensitive and other grievances are two separate grants: a user may hold
// either half, and the My Tasks sensitivity filter offers only the halves they hold.
export const GRIEVANCES_VIEW_LIST_NON_SENSITIVE_PERMISSIONS: string[] = [
...
export const GRIEVANCES_VIEW_LIST_SENSITIVE_PERMISSIONS: string[] = [
