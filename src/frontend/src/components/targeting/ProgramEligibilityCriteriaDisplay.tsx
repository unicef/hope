...
import Criteria from '@components/targeting/TargetingCriteriaDisplay/Criteria';
import ExcludeCheckboxes from '@components/targeting/TargetingCriteriaDisplay/ExcludeCheckboxes';
import TargetingCriteriaDisplayDisabled, {
  ContentWrapper,
} from '@components/targeting/TargetingCriteriaDisplay/TargetingCriteriaDisplayDisabled';
import { VulnerabilityScoreComponent } from '@components/targeting/TargetingCriteriaDisplay/VulnerabilityScoreComponent';
...
interface ProgramEligibilityCriteriaDisplayProps {
  rules?;
  helpers?;
...
const ProgramEligibilityCriteriaDisplay = ({
  rules,
  helpers,
  targetPopulation,
  isEdit,
  ...
  isSocialDctType,
  isStandardDctType,
}: ProgramEligibilityCriteriaDisplayProps): ReactElement => {
  ...
  const addCriteria = (values): void => {
    if (!helpers) {
      console.error(
        'ProgramEligibilityCriteriaDisplay: helpers not available in read-only mode',
      );
      return closeModal();
    }
