...
export class RestService {
  ...
  public static restBusinessAreasPaymentsPaymentPlansManagerialList({
    ...
    businessAreaSlug: string;
    /**
     * * `38158d61-d027-490e-8f66-24e886dc1356` - Another miss production.
     * * `531e3e68-6c91-438a-a76d-8947011e06a4` - Eye ever into.
     * * `82abea61-1f4b-4c3f-afe2-fbee207b9e39` - Of manager tax reveal my.
     * * `8d66db45-7e7b-4175-ac8b-43fb84f10f95` - Relationship fine yes.
     * * `atm_card` - ATM Card
     * * `c983ef50-3b45-48ab-a5b2-984596c945be` - Check statement house where.
     * * `cardless_cash_withdrawal` - Cardless cash withdrawal
     * * `cash` - Cash
     * * `cash_by_fsp` - Cash by FSP
     * * `cash_over_the_counter` - Cash over the counter
     * * `cdd47d6e-0a42-4ebb-b966-d555671810d4` - Give science hit necessary side.
     * * `cheque` - Cheque
     ...
     * * `voucher` - Voucher
     */
    deliveryMechanism?: Array<
      | '38158d61-d027-490e-8f66-24e886dc1356'
      | '531e3e68-6c91-438a-a76d-8947011e06a4'
      | '82abea61-1f4b-4c3f-afe2-fbee207b9e39'
      | '8d66db45-7e7b-4175-ac8b-43fb84f10f95'
      | 'atm_card'
      | 'c983ef50-3b45-48ab-a5b2-984596c945be'
      | 'cardless_cash_withdrawal'
      | 'cash'
      | 'cash_by_fsp'
      | 'cash_over_the_counter'
      | 'cdd47d6e-0a42-4ebb-b966-d555671810d4'
      | 'cheque'
      | 'deposit_to_card'
      | 'mobile_money'
      | 'pre-paid_card'
