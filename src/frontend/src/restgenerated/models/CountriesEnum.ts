...
export enum CountriesEnum {
    ...
    CAMEROON = 'Cameroon',
    CONGO_THE_DEMOCRATIC_REPUBLIC_OF_THE_ = 'Congo (the Democratic Republic of the)',
    CONGO = 'Congo',
    ...
    TAIWAN = 'Taiwan',
    TANZANIA = 'Tanzania',
    UNKNOWN_OR_NOT_APPLICABLE = 'Unknown or Not Applicable',
    UGANDA = 'Uganda',
    UKRAINE = 'Ukraine',
