    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('funds_commitment_group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='funds_commitment_items', to='vision.fundscommitmentgroup')),
                ('office',
