...
urlpatterns = [
    ...
    path(
        "business_areas/",
        endpoints.core.BusinessAreaListView.as_view(),
        name="business-area-list",
    ),
    path("programs/", ProgramGlobalListView.as_view(), name="program-global-list"),
    path(
        "",
        include(
            "hct_mis_api.apps.program.api.urls.beneficiary_group",
            namespace="beneficiary-group",
        ),
    ),
        ...
        include(
            [
                path(
                    "payments/",
                    include(
                        "hct_mis_api.apps.payment.api.urls.payments",
                        namespace="payments",
                    ),
                ),
                path(
                    ...
                    include(
                        [
                            path(
                                ...
                                include(
                                    "hct_mis_api.apps.payment.api.urls.payment_plans",
                                    namespace="payment-plan",
                                ),
                            ),
                            path(
                                "periodic-data-update/",
                                include(
                                    "hct_mis_api.apps.periodic_data_update.api.urls",
                                    namespace="periodic-data-update",
                                ),
                            ),
                            path(
                                "registration-data/",
                                include(
                                    "hct_mis_api.apps.registration_data.api.urls",
                            ...
                            path(
                                "targeting/",
                                include(
                                    "hct_mis_api.apps.targeting.api.urls",
                                    namespace="targeting",
                                ),
                            ),
                            path(
                                "",
                                include(
                                    "hct_mis_api.apps.program.api.urls.program_related",
                                    namespace="programs",
                                ),
                            ),
                        ]
