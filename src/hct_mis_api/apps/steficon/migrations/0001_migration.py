    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('PAYMENT_PLAN', 'Payment Plan'), ('TARGETING', 'Targeting')], default='TARGETING', help_text='Use Rule for Targeting or Payment Plan', max_length=50)),
