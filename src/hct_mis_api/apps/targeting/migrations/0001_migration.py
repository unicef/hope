    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vulnerability_score', models.DecimalField(blank=True, db_index=True, decimal_places=3, help_text='Written by Steficon', max_digits=6, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, db_index=True)),
                ('updated_at', models.DateTimeField(auto_now=True, db_index=True)),
                ('flag_exclude_if_active_adjudication_ticket', models.BooleanField(default=False, help_text='Exclude households with individuals (members or collectors) that have active adjudication ticket(s).')),
                ('flag_exclude_if_on_sanction_list', models.BooleanField(default=False, help_text='Exclude households with individuals (members or collectors) on sanction list.')),
        ...
        migrations.CreateModel(
            ...
            bases=(models.Model, hct_mis_api.apps.targeting.services.targeting_service.TargetingCriteriaRuleQueryingBase),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('OPEN', 'Open'), ('LOCKED', 'Locked'), ('STEFICON_WAIT', 'Waiting for Rule Engine'), ('STEFICON_RUN', 'Rule Engine Running'), ('STEFICON_COMPLETED', 'Rule Engine Completed'), ('STEFICON_ERROR', 'Rule Engine Errored'), ('PROCESSING', 'Processing'), ('SENDING_TO_CASH_ASSIST', 'Sending to Cash Assist'), ('READY_FOR_CASH_ASSIST', 'Ready for cash assist'), ('READY_FOR_PAYMENT_MODULE', 'Ready for payment module'), ('ASSIGNED', 'Assigned')], db_index=True, default='OPEN', max_length=256)),
                ('build_status', models.CharField(choices=[('PENDING', 'Pending'), ('BUILDING', 'Building'), ('FAILED', 'Failed'), ('OK', 'Ok')], db_index=True, default='PENDING', max_length=256)),
                ...
                ('changed_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='changed_target_populations', to=settings.AUTH_USER_MODEL)),
                ...
                ('program', models.ForeignKey(help_text='Set only when the target population moves from draft to\n            candidate list frozen state (approved)', on_delete=django.db.models.deletion.PROTECT, to='program.program')),
                ('program_cycle', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='target_populations', to='program.programcycle')),
                ('steficon_rule', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='target_populations', to='steficon.rulecommit')),
                ('storage_file', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='core.storagefile')),
                ('targeting_criteria', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='target_population', to='targeting.targetingcriteria')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, db_index=True)),
                ('updated_at', models.DateTimeField(auto_now=True, db_index=True)),
                ('comparison_method', models.CharField(choices=[('EQUALS', 'Equals'), ('NOT_EQUALS', 'Not Equals'), ('CONTAINS', 'Contains'), ('NOT_CONTAINS', 'Does not contain'), ('RANGE', 'In between <>'), ('NOT_IN_RANGE', 'Not in between <>'), ('GREATER_THAN', 'Greater than'), ('LESS_THAN', 'Less than'), ('IS_NULL', 'Is null')], max_length=20)),
