...
class RegistrationDataImportCreateSerializer(serializers.Serializer):
    ...
    import_from_ids = serializers.CharField(required=True,allow_blank=True, help_text="String of Ind or HH ids separated by comma")
    ...
    def get_object(self, validated_data):
        ...
        import_from_program_id = validated_data.get("import_from_program_id")
