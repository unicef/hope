...
class HouseholdFactory(DjangoModelFactory):
    ...
    female_age_group_0_5_disabled_count = factory.fuzzy.FuzzyInteger(0, 2)
    ...
    female_age_group_18_59_disabled_count = factory.fuzzy.FuzzyInteger(0, 2)
    ...
    male_age_group_6_11_disabled_count = factory.fuzzy.FuzzyInteger(0, 2)
