    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('residence_status', models.CharField(blank=True, choices=[('', 'None'), ('IDP', 'Displaced  |  Internally Displaced People'), ('REFUGEE', 'Displaced  |  Refugee / Asylum Seeker'), ('OTHERS_OF_CONCERN', 'Displaced  |  Others of Concern'), ('HOST', 'Non-displaced  |   Host'), ('NON_HOST', 'Non-displaced  |   Non-host'), ('RETURNEE', 'Displaced  |   Returnee')], max_length=254)),
                ...
                ('org_enumerator', models.CharField(choices=[('', 'None'), ('PARTNER', 'Partner'), ('UNICEF', 'UNICEF')], default='', max_length=250)),
                ...
                ('collect_individual_data', models.CharField(choices=[('', 'Unknown'), ('2', 'Partial individuals collected'), ('1', 'Full individual collected'), ('3', 'Size only collected'), ('0', 'No individual data')], default='', max_length=250)),
                ...
                ('registration_id', django.contrib.postgres.fields.citext.CICharField(blank=True, db_index=True, max_length=100, null=True, verbose_name='Aurora Registration Id')),
                ('program_registration_id', django.contrib.postgres.fields.citext.CICharField(blank=True, db_index=True, max_length=100, null=True, unique=True, verbose_name='Beneficiary Program Registration Id')),
                ('total_cash_received_usd', models.DecimalField(blank=True, decimal_places=2, max_digits=64, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('marital_status', models.CharField(choices=[('', 'None'), ('DIVORCED', 'Divorced'), ('MARRIED', 'Married'), ('SEPARATED', 'Separated'), ('SINGLE', 'Single'), ('WIDOWED', 'Widowed')], db_index=True, default='', max_length=255)),
                ('phone_no', phonenumber_field.modelfields.PhoneNumberField(blank=True, db_index=True, max_length=128, region=None)),
                ('phone_no_valid', models.BooleanField(db_index=True, null=True)),
                ('phone_no_alternative', phonenumber_field.modelfields.PhoneNumberField(blank=True, db_index=True, max_length=128, region=None)),
                ('phone_no_alternative_valid', models.BooleanField(db_index=True, null=True)),
                ('email', models.CharField(blank=True, max_length=255)),
                ('payment_delivery_phone_no', phonenumber_field.modelfields.PhoneNumberField(blank=True, max_length=128, null=True, region=None)),
                ...
                ('flex_fields', models.JSONField(blank=True, default=dict, encoder=hct_mis_api.apps.core.utils.FlexFieldsEncoder)),
                ('user_fields', models.JSONField(blank=True, default=dict)),
                ('enrolled_in_nutrition_programme', models.BooleanField(null=True)),
                ('administration_of_rutf', models.BooleanField(null=True)),
                ('deduplication_golden_record_status', models.CharField(choices=[('DUPLICATE', 'Duplicate'), ('NEEDS_ADJUDICATION', 'Needs Adjudication'), ('NOT_PROCESSED', 'Not Processed'), ('POSTPONE', 'Postpone'), ('UNIQUE', 'Unique')], db_index=True, default='UNIQUE', max_length=50)),
                ('deduplication_batch_status', models.CharField(choices=[('DUPLICATE_IN_BATCH', 'Duplicate in batch'), ('NOT_PROCESSED', 'Not Processed'), ('SIMILAR_IN_BATCH', 'Similar in batch'), ('UNIQUE_IN_BATCH', 'Unique in batch')], db_index=True, default='UNIQUE_IN_BATCH', max_length=50)),
                ...
                ('detail_id', models.CharField(blank=True, help_text='Kobo asset ID, Xlsx row ID, Aurora source ID', max_length=150, null=True)),
                ('registration_id', django.contrib.postgres.fields.citext.CICharField(blank=True, max_length=100, null=True, verbose_name='Aurora Registration Id')),
                ('program_registration_id', django.contrib.postgres.fields.citext.CICharField(blank=True, max_length=100, null=True, verbose_name='Beneficiary Program Registration Id')),
