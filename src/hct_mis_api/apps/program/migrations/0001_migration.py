    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('ACTIVE', 'Active'), ('DRAFT', 'Draft'), ('FINISHED', 'Finished')], db_index=True, max_length=10)),
                ...
                ('frequency_of_payments', models.CharField(choices=[('ONE_OFF', 'One-off'), ('REGULAR', 'Regular')], max_length=50)),
                ...
                ('scope', models.CharField(blank=True, choices=[('FOR_PARTNERS', 'For partners'), ('UNICEF', 'Unicef')], max_length=50, null=True)),
                ...
                ('partner_access', models.CharField(choices=[('ALL_PARTNERS_ACCESS', 'All partners access'), ('NONE_PARTNERS_ACCESS', 'None partners access'), ('SELECTED_PARTNERS_ACCESS', 'Selected partners access')], default='SELECTED_PARTNERS_ACCESS', max_length=50)),
                ('biometric_deduplication_enabled', models.BooleanField(default=False, help_text='Enable Deduplication of Face Images')),
                ...
                ('data_collecting_type', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='programs', to='core.datacollectingtype')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(blank=True, default='Default Programme Cycle', max_length=255, null=True, verbose_name='Title')),
                ('status', models.CharField(choices=[('DRAFT', 'Draft'), ('ACTIVE', 'Active'), ('FINISHED', 'Finished')], db_index=True, default='DRAFT', max_length=10)),
