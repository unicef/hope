...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='household',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='negative_feedback_ticket_details', to='household.household'),
        ),
        migrations.AddField(
            model_name='ticketnegativefeedbackdetails',
            name='individual',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='negative_feedback_ticket_details', to='household.individual'),
        ),
        migrations.AddField(
            model_name='ticketnegativefeedbackdetails',
            name='ticket',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='negative_feedback_ticket_details', to='grievance.grievanceticket'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='household',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='delete_household_ticket_details', to='household.household'),
        ),
        migrations.AddField(
            model_name='ticketdeletehouseholddetails',
        ...
        migrations.AddField(
            model_name='ticketdeletehouseholddetails',
            name='ticket',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='delete_household_ticket_details', to='grievance.grievanceticket'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='support_documents', to='grievance.grievanceticket'),
        ),
