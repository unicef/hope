...
class Mutations(graphene.ObjectType):
    ...
    update_grievance_ticket = UpdateGrievanceTicketMutation.Field()  # in progress [almost DONE]
    grievance_status_change = GrievanceStatusChangeMutation.Field()  # in progress [almost DONE]
    create_ticket_note = CreateTicketNoteMutation.Field()  # DONE
    approve_individual_data_change = IndividualDataChangeApproveMutation.Field()  # DONE
    approve_household_data_change = HouseholdDataChangeApproveMutation.Field()  # DONE
    approve_add_individual = SimpleApproveMutation.Field()  # DONE
    approve_delete_individual = SimpleApproveMutation.Field()  # DONE
    approve_delete_household = DeleteHouseholdApproveMutation.Field()  # DONE
    approve_system_flagging = SimpleApproveMutation.Field()  # DONE
    approve_needs_adjudication = NeedsAdjudicationApproveMutation.Field()  # DONE
    approve_payment_details = PaymentDetailsApproveMutation.Field()  # DONE
    reassign_role = ReassignRoleMutation.Field()  # DONE
