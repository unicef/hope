...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            model_name='payment',
            name='copied_from',
            field=models.ForeignKey(blank=True, help_text='If this object was copied from another, this field will contain the object it was copied from.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='copied_to', to='payment.payment'),
        ),
        migrations.AddField(
            model_name='payment',
        ...
        migrations.AddField(
            ...
            name='copied_from',
            field=models.ForeignKey(blank=True, help_text='If this object was copied from another, this field will contain the object it was copied from.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='copied_to', to='payment.paymentrecord'),
        ),
        migrations.AddField(
            model_name='paymentrecord',
            name='is_migration_handled',
