...
import hct_mis_api.apps.payment.models.financial_service_provider_models
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('flex_fields', hct_mis_api.apps.payment.models.financial_service_provider_models.FlexFieldArrayField(base_field=models.CharField(blank=True, max_length=255), blank=True, default=list, size=None)),
