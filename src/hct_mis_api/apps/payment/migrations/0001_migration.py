    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_entitled_quantity', models.DecimalField(db_index=True, decimal_places=2, max_digits=12, null=True, validators=[django.core.validators.MinValueValidator(Decimal('0'))])),
                ('total_entitled_quantity_usd', models.DecimalField(blank=True, decimal_places=2, max_digits=12, null=True, validators=[django.core.validators.MinValueValidator(Decimal('0'))])),
                ('total_entitled_quantity_revised', models.DecimalField(blank=True, db_index=True, decimal_places=2, max_digits=12, null=True, validators=[django.core.validators.MinValueValidator(Decimal('0'))])),
                ('total_entitled_quantity_revised_usd', models.DecimalField(blank=True, decimal_places=2, max_digits=12, null=True, validators=[django.core.validators.MinValueValidator(Decimal('0'))])),
                ('total_delivered_quantity', models.DecimalField(blank=True, db_index=True, decimal_places=2, max_digits=12, null=True, validators=[django.core.validators.MinValueValidator(Decimal('0'))])),
                ('total_delivered_quantity_usd', models.DecimalField(blank=True, decimal_places=2, max_digits=12, null=True, validators=[django.core.validators.MinValueValidator(Decimal('0'))])),
                ('total_undelivered_quantity', models.DecimalField(blank=True, db_index=True, decimal_places=2, max_digits=12, null=True, validators=[django.core.validators.MinValueValidator(Decimal('0'))])),
                ('total_undelivered_quantity_usd', models.DecimalField(blank=True, decimal_places=2, max_digits=12, null=True, validators=[django.core.validators.MinValueValidator(Decimal('0'))])),
                ...
                ('delivery_type', models.CharField(choices=[('Cardless cash withdrawal', 'Cardless cash withdrawal'), ('Cash', 'Cash'), ('Cash by FSP', 'Cash by FSP'), ('Cheque', 'Cheque'), ('Deposit to Card', 'Deposit to Card'), ('Mobile Money', 'Mobile Money'), ('Pre-paid card', 'Pre-paid card'), ('Referral', 'Referral'), ('Transfer', 'Transfer'), ('Transfer to Account', 'Transfer to Account'), ('Voucher', 'Voucher'), ('ATM Card', 'ATM Card'), ('Cash over the counter', 'Cash over the counter'), ('Transfer to Digital Wallet', 'Transfer to Digital Wallet')], db_index=True, max_length=32, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('optional_fields', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=255), default=list, size=None)),
                ...
                ('transfer_type', models.CharField(choices=[('CASH', 'Cash'), ('VOUCHER', 'Voucher'), ('DIGITAL', 'Digital')], default='CASH', max_length=255)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('core_fields', hct_mis_api.apps.payment.fields.DynamicChoiceArrayField(base_field=models.CharField(blank=True, max_length=255), blank=True, default=list, size=None)),
                ('flex_fields', hct_mis_api.apps.payment.models.FlexFieldArrayField(base_field=models.CharField(blank=True, max_length=255), blank=True, default=list, size=None)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Distribution Successful', 'Distribution Successful'), ('Not Distributed', 'Not Distributed'), ('Transaction Successful', 'Transaction Successful'), ('Transaction Erroneous', 'Transaction Erroneous'), ('Force failed', 'Force failed'), ('Partially Distributed', 'Partially Distributed'), ('Pending', 'Pending'), ('Sent to Payment Gateway', 'Sent to Payment Gateway'), ('Sent to FSP', 'Sent to FSP'), ('Manually Cancelled', 'Manually Cancelled')], default='Pending', max_length=255)),
                ('status_date', models.DateTimeField()),
                ('delivery_type_choice', models.CharField(choices=[('Cardless cash withdrawal', 'Cardless cash withdrawal'), ('Cash', 'Cash'), ('Cash by FSP', 'Cash by FSP'), ('Cheque', 'Cheque'), ('Deposit to Card', 'Deposit to Card'), ('Mobile Money', 'Mobile Money'), ('Pre-paid card', 'Pre-paid card'), ('Referral', 'Referral'), ('Transfer', 'Transfer'), ('Transfer to Account', 'Transfer to Account'), ('Voucher', 'Voucher'), ('ATM Card', 'ATM Card'), ('Cash over the counter', 'Cash over the counter'), ('Transfer to Digital Wallet', 'Transfer to Digital Wallet')], max_length=32, null=True)),
                ('currency', models.CharField(max_length=4)),
                ('entitlement_quantity', models.DecimalField(blank=True, decimal_places=2, max_digits=12, null=True, validators=[django.core.validators.MinValueValidator(Decimal('0.00'))])),
                ('entitlement_quantity_usd', models.DecimalField(blank=True, decimal_places=2, max_digits=12, null=True, validators=[django.core.validators.MinValueValidator(Decimal('0.00'))])),
                ('delivered_quantity', models.DecimalField(blank=True, decimal_places=2, max_digits=12, null=True, validators=[django.core.validators.MinValueValidator(Decimal('0.00'))])),
                ('delivered_quantity_usd', models.DecimalField(blank=True, decimal_places=2, max_digits=12, null=True, validators=[django.core.validators.MinValueValidator(Decimal('0.00'))])),
                ...
                ('order_number', models.PositiveIntegerField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(100000000), django.core.validators.MaxValueValidator(999999999), hct_mis_api.apps.payment.validators.payment_token_and_order_number_validator])),
                ('token_number', models.PositiveIntegerField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(1000000), django.core.validators.MaxValueValidator(9999999), hct_mis_api.apps.payment.validators.payment_token_and_order_number_validator])),
                ('additional_collector_name', models.CharField(blank=True, help_text='Use this field for reconciliation data when funds are collected by someone other than the designated collector or the alternate collector', max_length=64, null=True)),
                ('additional_document_type', models.CharField(blank=True, help_text='Use this field for reconciliation data', max_length=128, null=True)),
                ('additional_document_number', models.CharField(blank=True, help_text='Use this field for reconciliation data', max_length=128, null=True)),
                ('fsp_auth_code', models.CharField(blank=True, help_text='FSP Auth Code', max_length=128, null=True)),
                ('business_area', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.businessarea')),
                ('collector', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='collector_payments', to='household.individual')),
                ('delivery_type', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='payment.deliverymechanism')),
                ('financial_service_provider', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='payment.financialserviceprovider')),
                ('head_of_household', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='household.individual')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_undelivered_quantity', models.DecimalField(blank=True, db_index=True, decimal_places=2, max_digits=12, null=True, validators=[django.core.validators.MinValueValidator(Decimal('0'))])),
                ('total_undelivered_quantity_usd', models.DecimalField(blank=True, decimal_places=2, max_digits=12, null=True, validators=[django.core.validators.MinValueValidator(Decimal('0'))])),
                ('status', django_fsm.FSMField(choices=[('PREPARING', 'Preparing'), ('OPEN', 'Open'), ('LOCKED', 'Locked'), ('LOCKED_FSP', 'Locked FSP'), ('IN_APPROVAL', 'In Approval'), ('IN_AUTHORIZATION', 'In Authorization'), ('IN_REVIEW', 'In Review'), ('ACCEPTED', 'Accepted'), ('FINISHED', 'Finished')], db_index=True, default='OPEN', max_length=50)),
                ...
                ('name', models.CharField(blank=True, max_length=255, null=True, validators=[django.core.validators.MinLengthValidator(3), django.core.validators.MaxLengthValidator(255)])),
                ('business_area', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.businessarea')),
                ...
                ('export_file_entitlement', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='core.filetemp')),
                ('export_file_per_fsp', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='core.filetemp')),
                ('export_pdf_file_summary', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='core.filetemp')),
                ...
                ('program', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='program.program')),
                ('program_cycle', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='payment_plans', to='program.programcycle')),
                ('source_payment_plan', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='follow_ups', to='payment.paymentplan')),
                ('steficon_rule', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='payment_plans', to='steficon.rulecommit')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, db_index=True)),
                ('updated_at', models.DateTimeField(auto_now=True, db_index=True)),
                ('split_type', models.CharField(choices=[('BY_RECORDS', 'By Records'), ('BY_COLLECTOR', 'By Collector'), ('BY_ADMIN_AREA1', 'By Admin Area 1'), ('BY_ADMIN_AREA2', 'By Admin Area 2'), ('BY_ADMIN_AREA3', 'By Admin Area 3')], max_length=24)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, db_index=True)),
                ('updated_at', models.DateTimeField(auto_now=True, db_index=True)),
                ('status', models.CharField(choices=[('ACTIVE', 'Active'), ('FINISHED', 'Finished'), ('PENDING', 'Pending')], db_index=True, default='PENDING', max_length=50, verbose_name='Verification status')),
                ('activation_date', models.DateTimeField(null=True)),
                ('completion_date', models.DateTimeField(null=True)),
                ('payment_plan_object_id', models.UUIDField()),
                ('payment_plan_content_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='contenttypes.contenttype')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('version', concurrency.fields.IntegerVersionField(default=0, help_text='record revision number')),
                ('unicef_id', models.CharField(blank=True, db_index=True, max_length=255, null=True)),
                ('status', models.CharField(choices=[('ACTIVE', 'Active'), ('FINISHED', 'Finished'), ('PENDING', 'Pending'), ('INVALID', 'Invalid'), ('RAPID_PRO_ERROR', 'RapidPro Error')], db_index=True, default='PENDING', max_length=50)),
                ('payment_plan_object_id', models.UUIDField()),
                ('sampling', models.CharField(choices=[('FULL_LIST', 'Full list'), ('RANDOM', 'Random sampling')], max_length=50)),
                ('verification_channel', models.CharField(choices=[('MANUAL', 'MANUAL'), ('RAPIDPRO', 'RAPIDPRO'), ('XLSX', 'XLSX')], max_length=50)),
                ...
                ('rapid_pro_flow_start_uuids', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(blank=True, max_length=255), default=list, size=None)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('NOT_RECEIVED', 'NOT RECEIVED'), ('PENDING', 'PENDING'), ('RECEIVED', 'RECEIVED'), ('RECEIVED_WITH_ISSUES', 'RECEIVED WITH ISSUES')], default='PENDING', max_length=50)),
                ...
                ('payment_verification_plan', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='payment_record_verifications', to='payment.paymentverificationplan')),
            ],
            bases=(models.Model, hct_mis_api.apps.utils.models.AdminUrlMixin),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('head_of_household', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='household.individual')),
                ('household', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='household.household')),
                ('parent', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='payment_items', to='payment.cashplan')),
                ('service_provider', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='payment.serviceprovider')),
        ...
        migrations.AddField(
            model_name='payment',
            name='parent',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='payment_items', to='payment.paymentplan'),
        ),
        migrations.AddField(
            model_name='payment',
            name='program',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, db_index=True)),
                ('updated_at', models.DateTimeField(auto_now=True, db_index=True)),
                ('delivery_mechanism_choice', models.CharField(choices=[('Cardless cash withdrawal', 'Cardless cash withdrawal'), ('Cash', 'Cash'), ('Cash by FSP', 'Cash by FSP'), ('Cheque', 'Cheque'), ('Deposit to Card', 'Deposit to Card'), ('Mobile Money', 'Mobile Money'), ('Pre-paid card', 'Pre-paid card'), ('Referral', 'Referral'), ('Transfer', 'Transfer'), ('Transfer to Account', 'Transfer to Account'), ('Voucher', 'Voucher'), ('ATM Card', 'ATM Card'), ('Cash over the counter', 'Cash over the counter'), ('Transfer to Digital Wallet', 'Transfer to Digital Wallet')], max_length=255, verbose_name='Delivery Mechanism')),
                ...
                ('delivery_mechanism', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='payment.deliverymechanism')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='created_delivery_mechanisms', to=settings.AUTH_USER_MODEL)),
                ('delivery_mechanism', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='payment.deliverymechanism')),
                ('financial_service_provider', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='delivery_mechanisms_per_payment_plan', to='payment.financialserviceprovider')),
                ('payment_plan', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='delivery_mechanisms', to='payment.paymentplan')),
                ('sent_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='sent_delivery_mechanisms', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', model_utils.fields.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('rdi_merge_status', models.CharField(choices=[('PENDING', 'Pending'), ('MERGED', 'Merged')], default='PENDING', max_length=10)),
                ('created_at', models.DateTimeField(auto_now_add=True, db_index=True)),
                ('updated_at', models.DateTimeField(auto_now=True, db_index=True)),
                ('signature_hash', models.CharField(blank=True, editable=False, max_length=40)),
                ('delivery_mechanism_choice', models.CharField(blank=True, choices=[('Cardless cash withdrawal', 'Cardless cash withdrawal'), ('Cash', 'Cash'), ('Cash by FSP', 'Cash by FSP'), ('Cheque', 'Cheque'), ('Deposit to Card', 'Deposit to Card'), ('Mobile Money', 'Mobile Money'), ('Pre-paid card', 'Pre-paid card'), ('Referral', 'Referral'), ('Transfer', 'Transfer'), ('Transfer to Account', 'Transfer to Account'), ('Voucher', 'Voucher'), ('ATM Card', 'ATM Card'), ('Cash over the counter', 'Cash over the counter'), ('Transfer to Digital Wallet', 'Transfer to Digital Wallet')], max_length=255, null=True, verbose_name='Delivery Mechanism')),
                ...
                ('delivery_mechanism', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='payment.deliverymechanism')),
                ('individual', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='delivery_mechanisms_data', to='household.individual')),
                ('possible_duplicate_of', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='possible_duplicates', to='payment.deliverymechanismdata')),
            ],
        ),
        migrations.AddField(
            model_name='cashplan',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sent_for_approval_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('sent_for_authorization_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('sent_for_finance_release_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, db_index=True)),
                ('updated_at', models.DateTimeField(auto_now=True, db_index=True)),
                ('type', models.CharField(choices=[('APPROVAL', 'Approval'), ('AUTHORIZATION', 'Authorization'), ('FINANCE_RELEASE', 'Finance Release'), ('REJECT', 'Reject')], default='APPROVAL', max_length=50, verbose_name='Approval type')),
        ...
        migrations.AddConstraint(
            model_name='payment',
            constraint=models.UniqueConstraint(condition=models.Q(('is_removed', False)), fields=('parent', 'household'), name='payment_plan_and_household'),
        ),
        migrations.AddConstraint(
            model_name='payment',
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('payment_plan', 'delivery_mechanism', 'delivery_mechanism_order'), name='unique payment_plan_delivery_mechanism'),
        ),
        migrations.AddConstraint(
