...
class PaymentDetailSerializer(AdminUrlSerializerMixin, PaymentListSerializer):
    ...
    def get_snapshot_collector_bank_name(self, obj: Payment) -> str | None:
        if bank_account_info := self.collector_field(obj, "bank_account_info"):
            return bank_account_info.get("bank_name")
        return None

    def get_snapshot_collector_bank_account_number(self, obj: Payment) -> str | None:
        if bank_account_info := self.collector_field(obj, "bank_account_info"):
            return bank_account_info.get("bank_account_number")
        return None

    def get_snapshot_collector_debit_card_number(self, obj: Payment) -> str | None:
        if bank_account_info := self.collector_field(obj, "bank_account_info"):
