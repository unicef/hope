...
from hct_mis_api.apps.payment.models.payment_plan_model import PaymentPlan
...
if TYPE_CHECKING:
    from hct_mis_api.apps.payment.models.deprecated_cash_assist_models import CashPlan
