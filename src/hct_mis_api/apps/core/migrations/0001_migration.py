    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deduplication_duplicate_score', models.FloatField(default=6.0, help_text='Results equal or above this score are considered duplicates', validators=[django.core.validators.MinValueValidator(0.0)])),
                ('deduplication_possible_duplicate_score', models.FloatField(default=6.0, help_text='Results equal or above this score are considered possible duplicates (needs adjudication) must be lower than deduplication_duplicate_score', validators=[django.core.validators.MinValueValidator(0.0)])),
                ('deduplication_batch_duplicates_percentage', models.IntegerField(default=50, help_text='If percentage of duplicates is higher or equal to this setting, deduplication is aborted')),
                ('deduplication_batch_duplicates_allowed', models.IntegerField(default=5, help_text='If amount of duplicates for single individual exceeds this limit deduplication is aborted')),
                ('deduplication_golden_record_duplicates_percentage', models.IntegerField(default=50, help_text='If percentage of duplicates is higher or equal to this setting, deduplication is aborted')),
                ('deduplication_golden_record_duplicates_allowed', models.IntegerField(default=5, help_text='If amount of duplicates for single individual exceeds this limit deduplication is aborted')),
                ...
                ('biometric_deduplication_threshold', models.FloatField(default=0.0, help_text='Threshold for Face Image Deduplication', validators=[django.core.validators.MinValueValidator(0.0), django.core.validators.MaxValueValidator(100.0)])),
            ...
            options={
                'ordering': ['name'],
                'permissions': (('can_split', 'Can split BusinessArea'), ('can_send_doap', 'Can send DOAP matrix'), ('can_reset_doap', 'Can force sync DOAP matrix'), ('can_export_doap', 'Can export DOAP matrix')),
            },
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(blank=True, choices=[('STANDARD', 'Standard'), ('SOCIAL', 'Social Workers')], max_length=32, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, db_index=True)),
                ('updated_at', models.DateTimeField(auto_now=True, db_index=True)),
                ('type', models.CharField(choices=[('DATE', 'Date'), ('DECIMAL', 'Decimal'), ('IMAGE', 'Image'), ('INTEGER', 'Integer'), ('GEOPOINT', 'Geopoint'), ('SELECT_ONE', 'Select One'), ('SELECT_MANY', 'Select Many'), ('STRING', 'String'), ('PDU', 'PDU')], max_length=16)),
                ('name', models.CharField(max_length=255)),
                ('required', models.BooleanField(default=False)),
                ('label', models.JSONField(default=dict, validators=[hct_mis_api.apps.core.models.label_contains_english_en_validator])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('subtype', models.CharField(choices=[('DATE', 'Date'), ('DECIMAL', 'Number'), ('STRING', 'Text'), ('BOOL', 'Boolean (true/false)')], max_length=16)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('CONNECTION_FAILED', 'Connection failed'), ('PROCESSING', 'Processing'), ('SUCCESSFUL', 'Successful'), ('UNSUCCESSFUL', 'Unsuccessful'), ('UPLOADED', 'Uploaded')], max_length=200)),
